...
| **Vendor** | ttpears |
| **Stars** | ⭐ 2 |
| **npm Package** | `@ttpears/gitlab-mcp-server` |
| **npm Downloads (30d)** | 407 |
| **Language** | JavaScript |
| **Source** | [ttpears-gitlab-mcp](https://github.com/ttpears/gitlab-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ttpears-gitlab-mcp.json)*
