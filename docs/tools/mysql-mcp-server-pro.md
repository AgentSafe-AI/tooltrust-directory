...
**Description:**
Tool set changed silently at v1.7.0: 3 tool(s) added, 4 tool(s) removed without a version bump.
...
**Description:**
tool name "get_mcp_server_details" implies read-only operation but declares exec permission
