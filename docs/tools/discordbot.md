...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [discordbot](https://smithery.ai/server/discordbot) |
...
**Description:**
input parameter "interaction_token" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/discordbot.json)*
