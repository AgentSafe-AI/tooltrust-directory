...
**Description:**
tool name "get_npm_package" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_pypi_package" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nexgendata-apify-developer-tools-mcp-server.json)*
