...
**Description:**
Tool set changed silently at v1.15.2: 12 tool(s) added, 7 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/gateway.json)*
