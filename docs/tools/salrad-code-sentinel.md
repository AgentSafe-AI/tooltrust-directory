...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [salrad-code-sentinel](https://smithery.ai/server/salrad/code-sentinel) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/salrad-code-sentinel.json)*
