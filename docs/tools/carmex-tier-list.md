...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [carmex-tier-list](https://smithery.ai/server/carmex/tier-list) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/carmex-tier-list.json)*
