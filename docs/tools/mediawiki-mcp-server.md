...
**Description:**
Tool set changed silently at v0.17.0: 23 tool(s) added, 1 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mediawiki-mcp-server.json)*
