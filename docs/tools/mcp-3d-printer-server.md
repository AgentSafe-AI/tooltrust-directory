...
**Description:**
Tool set changed silently at v1.2.3: 7 tool(s) added, 0 tool(s) removed without a version bump.
...
**Description:**
tool name "set_printer_temperature" implies local write operation but only remote/network-class permissions were detected
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-3d-printer-server.json)*
