# 🟢 postly-postly-social-publisher
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [postly-postly-social-publisher](https://smithery.ai/server/postly/postly-social-publisher) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/postly-postly-social-publisher.json)*
