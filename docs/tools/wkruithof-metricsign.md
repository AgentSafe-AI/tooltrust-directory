...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [wkruithof-metricsign](https://smithery.ai/server/wkruithof/metricsign) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/wkruithof-metricsign.json)*
