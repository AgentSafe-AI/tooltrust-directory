...
**Description:**
Tool set changed silently at v17.0.0: 11 tool(s) added, 2 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/agentic-awesome-skills.json)*
