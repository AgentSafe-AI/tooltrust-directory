...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [magic-sauce-quickchart-mcp-server](https://smithery.ai/server/Magic-Sauce/quickchart-mcp-server) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/magic-sauce-quickchart-mcp-server.json)*
