...
Funciona em qualquer cliente MCP. Servidor remoto: `https://api.mcp.ai/p_nubank`
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [mcp-dir-nubank-mcp](https://smithery.ai/server/mcp-dir/nubank-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-dir-nubank-mcp.json)*
