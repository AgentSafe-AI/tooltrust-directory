...
**Description:**
tool name "search_modules" implies read-only operation but declares network permission
...
**Description:**
tool name "search_policies" implies read-only operation but declares network permission
