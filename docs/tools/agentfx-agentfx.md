...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [agentfx-agentfx](https://smithery.ai/server/agentfx/agentfx) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/agentfx-agentfx.json)*
