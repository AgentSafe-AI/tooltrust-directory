...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [quantoracle-quantoracle](https://smithery.ai/server/QuantOracle/quantoracle) |
...
**Description:**
Tool set changed silently at vsmithery: 74 tool(s) added, 63 tool(s) removed without a version bump.
...
**Description:**
input parameter "total_tokens" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/quantoracle-quantoracle.json)*
