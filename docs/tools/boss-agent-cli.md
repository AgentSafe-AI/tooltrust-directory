...
**Description:**
Tool set changed silently at v1.20.0: 66 tool(s) added, 13 tool(s) removed without a version bump.
...
**Description:**
input parameter "rider_token" accepts a credential (informational; not evidence of insecure handling)
