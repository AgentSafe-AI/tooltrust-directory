...
**Description:**
Tool set changed silently at v1.18.0: 25 tool(s) added, 13 tool(s) removed without a version bump.
...
**Description:**
tool name "get_customer_files" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_bazaar_listing_kit" implies read-only operation but declares exec permission
