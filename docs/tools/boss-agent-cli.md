...
**Description:**
Tool set changed silently at v1.14.0: 31 tool(s) added, 6 tool(s) removed without a version bump.
...
**Description:**
input parameter "max_token_budget" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "verify_token" accepts a credential (informational; not evidence of insecure handling)
