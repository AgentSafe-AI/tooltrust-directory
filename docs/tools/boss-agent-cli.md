...
**Description:**
Tool set changed silently at v1.18.0: 12 tool(s) added, 13 tool(s) removed without a version bump.
...
**Description:**
input parameter "token_limit" accepts a credential (informational; not evidence of insecure handling)
