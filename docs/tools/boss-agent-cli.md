...
**Description:**
Tool set changed silently at v1.13.1: 1515 tool(s) added, 8 tool(s) removed without a version bump.
...
**Description:**
input parameter "collateral_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "price_per_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "token_ttl_seconds" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
declared capabilities: filesystem access, environment variables, HTTP requests
...
**Description:**
input parameter "max_price_per_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "credential_id" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
tool name "procurement_evaluate_bids" duplicates "procurement_evaluate_bids" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
**Description:**
input parameter "insight_token_id" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "identity_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "to_token_id" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "from_token_id" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
tool description suggests privilege escalation: "impersonate"

**Recommendation:**
Restrict OAuth/token scopes to the minimum necessary. Remove admin, :write wildcards, and any description-level escalation signals (sudo, impersonate).
...
**Description:**
input parameter "amount_tokens" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "card_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "test_card_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "secret_key" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
tool name "zk_verify_proof" duplicates "zk_verify_proof" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
**Description:**
tool name "energy_dashboard" duplicates "energy_dashboard" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
**Description:**
tool name "logistics_track" duplicates "logistics_track" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/boss-agent-cli.json)*
