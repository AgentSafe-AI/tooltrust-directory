...
**Description:**
Tool set changed silently at vFeature: 16 tool(s) added, 3 tool(s) removed without a version bump.
...
**Description:**
tool name "get_conversation" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/dainfernalcoder-perplexity-mcp.json)*
