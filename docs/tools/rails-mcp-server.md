...
**Description:**
Tool set changed silently at v2.0.0: 76 tool(s) added, 4 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/rails-mcp-server.json)*
