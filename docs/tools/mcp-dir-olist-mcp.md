...
Funciona em qualquer cliente MCP. Servidor remoto: `https://api.mcp.ai/p_olist`
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [mcp-dir-olist-mcp](https://smithery.ai/server/mcp-dir/olist-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-dir-olist-mcp.json)*
