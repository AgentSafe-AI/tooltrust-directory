...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [axel-belfort-html-to-markdown](https://smithery.ai/server/axel-belfort/html-to-markdown) |
...
**Description:**
Tool set changed silently at vsmithery: 10 tool(s) added, 1 tool(s) removed without a version bump.
...
**Description:**
tool name "get_template_details" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/axel-belfort-html-to-markdown.json)*
