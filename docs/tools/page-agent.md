...
**Description:**
Tool set changed silently at v1.10.0: 31 tool(s) added, 8 tool(s) removed without a version bump.
...
**Description:**
input parameter "callback_secret" accepts a credential (informational; not evidence of insecure handling)
