...
| **Grade** | **C** |
| **Risk Score** | 25 |
| **Version** | `sha-7efe4fd43771` |
| **Vendor** | kamath |
| **Language** | Python |
| **Source** | [kamath-sample-python-mcp](https://github.com/kamath/sample-python-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/kamath-sample-python-mcp.json)*
