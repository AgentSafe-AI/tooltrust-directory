...
| **Language** | TypeScript |
| **Source** | [hoklims-stacksfinder-mcp](https://github.com/hoklims/stacksfinder-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/hoklims-stacksfinder-mcp.json)*
