...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [businesszilioli-arcadetrading](https://smithery.ai/server/businesszilioli/ArcadeTrading) |
...
**Description:**
input parameter "tokensIn" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/businesszilioli-arcadetrading.json)*
