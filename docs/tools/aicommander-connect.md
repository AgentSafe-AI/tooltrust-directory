...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [aicommander-connect](https://smithery.ai/server/aicommander/connect) |
...
**Description:**
possible prompt injection detected in tool description: pattern matched: (?i)exfiltrate\s+(?:\w+\s+){0,2}(?:data|info|credentials?|secrets?|content|results?)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/aicommander-connect.json)*
