...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [eren-solutions-agent-guardrail](https://smithery.ai/server/eren-solutions/agent-guardrail) |
...
**Description:**
tool name "get_stats" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/eren-solutions-agent-guardrail.json)*
