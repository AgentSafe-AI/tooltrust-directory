...
**Description:**
tool name "get_job_run_artifacts" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/dbt-mcp.json)*
