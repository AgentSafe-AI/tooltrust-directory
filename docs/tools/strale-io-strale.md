...
| **npm Package** | `strale` |
| **Language** | TypeScript |
| **Source** | [strale-io-strale](https://github.com/strale-io/strale) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/strale-io-strale.json)*
