...
> No-code platform to build databases, forms, portals and AI-powered sites. Manage your data and automate workflows via natural language using 104 MCP tools.
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [igor-vbfp-quintadb](https://smithery.ai/server/igor-vbfp/quintadb) |
...
**Description:**
input schema exposes 37 properties (threshold: 10)
...
**Description:**
input parameter "basic_password" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/igor-vbfp-quintadb.json)*
