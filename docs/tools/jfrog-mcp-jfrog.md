...
**Description:**
declared capabilities: code/command execution, network access, filesystem access, environment variables
...
**Description:**
input schema exposes 65 properties (threshold: 10)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/jfrog-mcp-jfrog.json)*
