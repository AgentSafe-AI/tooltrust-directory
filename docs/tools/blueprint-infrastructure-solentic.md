...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [blueprint-infrastructure-solentic](https://smithery.ai/server/blueprint-infrastructure/Solentic) |
...
**Description:**
input parameter "secretKey" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/blueprint-infrastructure-solentic.json)*
