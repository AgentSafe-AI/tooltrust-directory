...
**Description:**
Tool set changed silently at v3.0.8: 9 tool(s) added, 4 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/iai-personal-memory-engine.json)*
