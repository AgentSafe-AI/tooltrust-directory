...
| **Version** | `1.0.0` |
| **Vendor** | kamath |
| **npm Package** | `hello from sentry` |
| **Language** | TypeScript |
| **Source** | [kamath-hello-from-sentry](https://github.com/kamath/hello-from-sentry) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/kamath-hello-from-sentry.json)*
