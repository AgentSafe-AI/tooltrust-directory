...
**Description:**
Tool set changed silently at verify-v3.20.1: 62 tool(s) added, 22 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/emilia-protocol.json)*
