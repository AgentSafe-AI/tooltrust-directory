...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [clm-studios-nephyr-weather](https://smithery.ai/server/clm-studios/nephyr-weather) |
...
**Description:**
input parameter "kalshi_api_key" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/clm-studios-nephyr-weather.json)*
