...
**Description:**
Tool set changed silently at v2.10.47: 1278 tool(s) added, 18 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/home-assistant-vibecode-agent.json)*
