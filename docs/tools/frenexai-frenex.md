...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [frenexai-frenex](https://smithery.ai/server/frenexai/frenex) |
...
**Description:**
tool name "respond_to_challenge" duplicates "respond_to_challenge" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/frenexai-frenex.json)*
