...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [browserbase](https://smithery.ai/server/browserbase) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/browserbase.json)*
