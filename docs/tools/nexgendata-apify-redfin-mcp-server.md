# 🟢 nexgendata-apify-redfin-mcp-server
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [nexgendata-apify-redfin-mcp-server](https://smithery.ai/server/nexgendata-apify/redfin-mcp-server) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nexgendata-apify-redfin-mcp-server.json)*
