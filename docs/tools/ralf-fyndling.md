...
**Description:**
tool name "find_events_near" implies read-only operation but declares exec permission
...
**Description:**
tool name "list_events" implies read-only operation but declares exec permission
...
**Description:**
tool name "find_pois_near" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ralf-fyndling.json)*
