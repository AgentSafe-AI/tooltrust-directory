...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [machinehearts-machinehearts](https://smithery.ai/server/machinehearts/machinehearts) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/machinehearts-machinehearts.json)*
