...
**Description:**
Tool set changed silently at vsmithery: 35 tool(s) added, 5 tool(s) removed without a version bump.
...
**Description:**
input parameter "token_addresses" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "token0" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "token1" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "reward_tokens" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nexgendata-apify-finance-mcp-server.json)*
