...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [vercel](https://smithery.ai/server/vercel) |
...
**Description:**
tool name "get_runtime_logs" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/vercel.json)*
