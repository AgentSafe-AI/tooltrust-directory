# 🟢 nexgendata-apify-social-content-mcp-server
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [nexgendata-apify-social-content-mcp-server](https://smithery.ai/server/nexgendata-apify/social-content-mcp-server) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nexgendata-apify-social-content-mcp-server.json)*
