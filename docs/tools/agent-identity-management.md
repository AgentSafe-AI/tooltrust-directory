...
**Description:**
Tool set changed silently at v1.23.0: 35 tool(s) added, 7 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/agent-identity-management.json)*
