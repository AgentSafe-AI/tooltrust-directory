# 🟡 investmentchacha-earningsprism
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [investmentchacha-earningsprism](https://smithery.ai/server/investmentchacha/earningsprism) |
...
**Description:**
tool name "get_filings_6k" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/investmentchacha-earningsprism.json)*
