...
**Description:**
Tool set changed silently at v5.2.0: 1 tool(s) added, 5 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/jscpd.json)*
