...
**Description:**
Tool set changed silently at v0.5.1: 9 tool(s) added, 8 tool(s) removed without a version bump.
...
**Description:**
input parameter "redact_secrets" appears to accept a secret or credential
