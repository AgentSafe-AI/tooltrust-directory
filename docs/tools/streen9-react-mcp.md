...
**Description:**
Tool set changed silently at v0.1.0: 16 tool(s) added, 9 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/streen9-react-mcp.json)*
