...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [cyong80-subway-mcp](https://smithery.ai/server/cyong80/subway-mcp) |
...
**Description:**
Tool set changed silently at vsmithery: 3 tool(s) added, 23 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/cyong80-subway-mcp.json)*
