...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [bitpoort-on-chain-data](https://smithery.ai/server/bitpoort/on-chain-data) |
...
**Description:**
tool name "search_rag" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/bitpoort-on-chain-data.json)*
