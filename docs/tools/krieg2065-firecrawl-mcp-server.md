...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [krieg2065-firecrawl-mcp-server](https://smithery.ai/server/Krieg2065/firecrawl-mcp-server) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/krieg2065-firecrawl-mcp-server.json)*
