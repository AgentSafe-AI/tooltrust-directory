...
**Description:**
Tool set changed silently at v0.7.0: 13 tool(s) added, 19 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/google-analytics-mcp.json)*
