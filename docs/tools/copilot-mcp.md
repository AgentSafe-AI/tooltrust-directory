...
**Description:**
Tool set changed silently at v0.0.97: 7 tool(s) added, 10 tool(s) removed without a version bump.
...
**Description:**
input parameter "tokenType" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/copilot-mcp.json)*
