...
**Description:**
Tool set changed silently at v3.2.0: 45 tool(s) added, 5 tool(s) removed without a version bump.
...
**Description:**
input parameter "budgetTokens" accepts a credential (informational; not evidence of insecure handling)
