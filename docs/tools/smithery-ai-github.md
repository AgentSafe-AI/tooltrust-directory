...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [smithery-ai-github](https://smithery.ai/server/smithery-ai/github) |
...
**Description:**
Tool set changed silently at vsmithery: 64 tool(s) added, 11 tool(s) removed without a version bump.
...
**Description:**
tool name "get_copilot_space" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/smithery-ai-github.json)*
