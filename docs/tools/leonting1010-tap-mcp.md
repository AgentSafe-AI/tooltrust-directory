# 🔴 leonting1010-tap-mcp

> Turn interface operations into deterministic programs. AI forges taps once, then any agent replays them forever at zero AI cost. 31 tools for browser automation, web scraping, and agent orchestration. 200+ community skills included.
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [leonting1010-tap-mcp](https://smithery.ai/server/LeonTing1010/tap-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/leonting1010-tap-mcp.json)*
