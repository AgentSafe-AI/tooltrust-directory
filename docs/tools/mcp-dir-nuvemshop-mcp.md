...
Funciona em qualquer cliente MCP. Servidor remoto: `https://api.mcp.ai/p_nuvemshop`
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-dir-nuvemshop-mcp.json)*
