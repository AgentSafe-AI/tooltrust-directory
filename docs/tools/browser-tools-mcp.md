...
**Description:**
tool name "read_script" implies read-only operation but declares exec permission
...
**Description:**
tool name "set_host_readme" implies local write operation but only remote/network-class permissions were detected
...
**Description:**
tool name "read_run_results" implies read-only operation but declares exec permission
