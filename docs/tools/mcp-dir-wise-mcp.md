...
**Description:**
Tool set changed silently at vsmithery: 214 tool(s) added, 12 tool(s) removed without a version bump.
...
**Description:**
input parameter "cardToken" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "paymentTokenUniqueReference" accepts a credential (informational; not evidence of insecure handling)
