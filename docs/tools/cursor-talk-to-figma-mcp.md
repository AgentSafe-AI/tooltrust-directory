...
**Description:**
Tool set changed silently at v0.3.5: 40 tool(s) added, 9 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/cursor-talk-to-figma-mcp.json)*
