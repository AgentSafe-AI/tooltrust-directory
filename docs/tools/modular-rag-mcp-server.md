...
**Description:**
Tool set changed silently at vsha-f658c5a4011c: 1 tool(s) added, 12 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/modular-rag-mcp-server.json)*
