...
**Description:**
Tool set changed silently at v0.1.18: 99 tool(s) added, 40 tool(s) removed without a version bump.
...
**Description:**
input schema exposes 35 properties (threshold: 10)
...
**Description:**
input schema exposes 54 properties (threshold: 10)
...
**Description:**
input schema exposes 63 properties (threshold: 10)
...
**Description:**
input schema exposes 48 properties (threshold: 10)
...
**Description:**
input parameter "add_threading_tokens" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input schema exposes 67 properties (threshold: 10)
...
**Description:**
input schema exposes 64 properties (threshold: 10)
...
**Description:**
input schema exposes 62 properties (threshold: 10)
...
**Description:**
input schema exposes 49 properties (threshold: 10)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-salesforce.json)*
