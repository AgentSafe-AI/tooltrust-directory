...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [ai-zerolab-mcp-figma](https://smithery.ai/server/ai-zerolab/mcp-figma) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ai-zerolab-mcp-figma.json)*
