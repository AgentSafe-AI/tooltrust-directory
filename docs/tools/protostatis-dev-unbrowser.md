...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [protostatis-dev-unbrowser](https://smithery.ai/server/protostatis-dev/unbrowser) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/protostatis-dev-unbrowser.json)*
