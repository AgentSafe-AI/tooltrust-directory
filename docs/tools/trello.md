...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [trello](https://smithery.ai/server/trello) |
...
**Description:**
input schema exposes 38 properties (threshold: 10)
...
**Description:**
input schema exposes 53 properties (threshold: 10)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/trello.json)*
