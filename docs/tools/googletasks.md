...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [googletasks](https://smithery.ai/server/googletasks) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/googletasks.json)*
