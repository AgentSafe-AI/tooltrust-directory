...
**Description:**
Tool set changed silently at v0.3.0: 16 tool(s) added, 22 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/easy-vibe.json)*
