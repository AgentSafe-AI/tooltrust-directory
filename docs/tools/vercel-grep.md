...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [vercel-grep](https://smithery.ai/server/vercel/grep) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/vercel-grep.json)*
