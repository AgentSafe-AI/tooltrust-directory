...
**Description:**
Tool set changed silently at v1.0.21: 14 tool(s) added, 15 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/cjo4m06-mcp-shrimp-task-manager.json)*
