...
**Description:**
Tool set changed silently at v1.0.0: 4 tool(s) added, 8 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ai-guide.json)*
