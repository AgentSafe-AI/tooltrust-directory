...
**Description:**
tool name "get_market_stats" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/openclaw-ai-intel.json)*
