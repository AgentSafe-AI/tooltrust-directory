...
**Description:**
Tool set changed silently at vsmithery: 34 tool(s) added, 2 tool(s) removed without a version bump.
...
**Description:**
input parameter "token_out" appears to accept a secret or credential
...
**Description:**
input parameter "token_in" appears to accept a secret or credential
