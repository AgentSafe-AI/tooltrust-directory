...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [safeagent-token-safety](https://smithery.ai/server/safeagent/token-safety) |
...
**Description:**
Tool set changed silently at vsmithery: 33 tool(s) added, 3 tool(s) removed without a version bump.
...
**Description:**
input parameter "token_in" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "token_out" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/safeagent-token-safety.json)*
