...
**Description:**
Tool set changed silently at vrmcp-v3.2.0: 16 tool(s) added, 3 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/rust-sdk.json)*
