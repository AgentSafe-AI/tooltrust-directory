...
**Description:**
Tool set changed silently at v0.3.0: 24 tool(s) added, 6 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-access-point.json)*
