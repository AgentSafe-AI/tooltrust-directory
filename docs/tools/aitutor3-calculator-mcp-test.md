...
**Description:**
Tool set changed silently at vsmithery: 4 tool(s) added, 1 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/aitutor3-calculator-mcp-test.json)*
