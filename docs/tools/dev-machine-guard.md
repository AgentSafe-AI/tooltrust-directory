...
**Description:**
Tool set changed silently at v1.15.0: 10 tool(s) added, 12 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/dev-machine-guard.json)*
