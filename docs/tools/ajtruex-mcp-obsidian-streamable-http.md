# 🟡 ajtruex-mcp-obsidian-streamable-http

| Field | Value |
|-------|-------|
| **Grade** | **B** |
| **Risk Score** | 17 |
| **Version** | `sha-0f6866bca0f2` |
| **Vendor** | ajtruex |
| **Stars** | ⭐ 1 |
| **Language** | Python |
| **Source** | [ajtruex-mcp-obsidian-streamable-http](https://github.com/ajtruex/mcp-obsidian-streamable-http) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ajtruex-mcp-obsidian-streamable-http.json)*
