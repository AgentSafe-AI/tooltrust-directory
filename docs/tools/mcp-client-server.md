...
**Description:**
Tool set changed silently at v0.1.0: 43 tool(s) added, 146 tool(s) removed without a version bump.
...
**Description:**
input parameter "paradiseToken" accepts a credential (informational; not evidence of insecure handling)
