...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [quotewise-quotewise](https://smithery.ai/server/quotewise/quotewise) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/quotewise-quotewise.json)*
