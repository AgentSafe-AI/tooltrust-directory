...
**Description:**
Tool set changed silently at v1.0.0: 86 tool(s) added, 36 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/git-mcp.json)*
