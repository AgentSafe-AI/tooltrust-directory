...
> AI agent gateway for calling any API securely. Bootstrap your agent in one call, discover tools, enforce OPA policies, and inject credentials automatically.

## Features
- One-call agent bootstrap with Ed25519 identity
- Tool registry with OpenAPI ingestion
- OPA policy enforcement
- Encrypted credential vault
- Tier-based daily limits (free/starter/pro/scale)
...
**Description:**
tool name "acme-mailer.send_email" duplicates "acme-mailer.send_email" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mirajmahmudul57-agentdevx.json)*
