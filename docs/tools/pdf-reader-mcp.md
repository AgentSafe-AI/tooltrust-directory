...
**Description:**
Tool set changed silently at v4.1.3: 4 tool(s) added, 45 tool(s) removed without a version bump.
...
**Description:**
input parameter "userPassword" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "ownerPassword" accepts a credential (informational; not evidence of insecure handling)
