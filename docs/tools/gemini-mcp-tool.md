...
**Description:**
Tool set changed silently at v1.2.0-beta.1: 5 tool(s) added, 1 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/gemini-mcp-tool.json)*
