...
**Description:**
Tool set changed silently at v1.3.9: 128 tool(s) added, 22 tool(s) removed without a version bump.
...
**Description:**
input parameter "access_tokens" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "webhook_token" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/barryyip0625-mcp-discord.json)*
