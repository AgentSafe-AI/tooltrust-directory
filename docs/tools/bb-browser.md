...
**Description:**
Tool set changed silently at v0.14.0: 32 tool(s) added, 18 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/bb-browser.json)*
