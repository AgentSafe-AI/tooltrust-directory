...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [nextcut-nextcut](https://smithery.ai/server/NextCut/nextcut) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nextcut-nextcut.json)*
