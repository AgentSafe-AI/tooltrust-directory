...
**Description:**
Tool set changed silently at v0.7.0: 31 tool(s) added, 29 tool(s) removed without a version bump.
...
**Description:**
input parameter "secrets" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/supabase-mcp.json)*
