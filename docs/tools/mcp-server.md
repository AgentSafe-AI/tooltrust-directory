...
**Description:**
tool name "search_and_geocode_tool" implies read-only operation but declares network permission
...
**Description:**
tool name "search_for" implies read-only operation but declares network permission
