...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [trust-security-scanner](https://smithery.ai/server/trust-security/scanner) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/trust-security-scanner.json)*
