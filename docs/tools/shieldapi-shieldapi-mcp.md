...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [shieldapi-shieldapi-mcp](https://smithery.ai/server/ShieldAPI/shieldapi-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/shieldapi-shieldapi-mcp.json)*
