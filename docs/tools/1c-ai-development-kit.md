...
**Description:**
Tool set changed silently at v1.2.0: 6 tool(s) added, 5 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/1c-ai-development-kit.json)*
