...
**Description:**
Tool set changed silently at v1.11.1: 358 tool(s) added, 13 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/trpc-agent-go.json)*
