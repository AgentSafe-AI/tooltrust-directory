...
**Description:**
tool name "describe_tool_input" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/apideck-mcp-server.json)*
