...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [struq-struq](https://smithery.ai/server/struq/struq) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/struq-struq.json)*
