...
**Description:**
Tool set changed silently at vlatest: 1 tool(s) added, 3 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/fusion-360-mcp-server.json)*
