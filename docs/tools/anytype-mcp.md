...
**Description:**
tool name "search_space" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/anytype-mcp.json)*
