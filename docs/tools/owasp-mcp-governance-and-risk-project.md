...
**Description:**
tool name "get_decision_details" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/owasp-mcp-governance-and-risk-project.json)*
