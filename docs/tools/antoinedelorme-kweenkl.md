...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [antoinedelorme-kweenkl](https://smithery.ai/server/antoinedelorme/kweenkl) |
...
**Description:**
input parameter "device_token" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/antoinedelorme-kweenkl.json)*
