...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [zobr-script-zobr-script](https://smithery.ai/server/zobr-script/zobr-script) |
...
**Description:**
Tool 'zs_execute' has no description - agents cannot reason about its purpose, and static analysis coverage is limited
...
**Description:**
Tool 'zs_validate' has no description - agents cannot reason about its purpose, and static analysis coverage is limited
...
**Description:**
Tool 'zs_operations' has no description - agents cannot reason about its purpose, and static analysis coverage is limited
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/zobr-script-zobr-script.json)*
