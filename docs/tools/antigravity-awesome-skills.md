...
**Description:**
Tool set changed silently at v13.5.0: 1 tool(s) added, 8 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/antigravity-awesome-skills.json)*
