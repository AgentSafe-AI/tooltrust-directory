...
**Description:**
Tool set changed silently at v4.13.1: 10 tool(s) added, 54 tool(s) removed without a version bump.
...
**Description:**
tool name "search_law" implies read-only operation but declares exec permission
