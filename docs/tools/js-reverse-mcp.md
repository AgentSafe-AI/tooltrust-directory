...
**Description:**
tool name "get_paused_info" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_request_initiator" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_script_source" implies read-only operation but declares exec permission
...
**Description:**
tool name "list_breakpoints" implies read-only operation but declares exec permission
...
**Description:**
tool name "list_scripts" implies read-only operation but declares exec permission
...
**Description:**
tool name "search_in_sources" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/js-reverse-mcp.json)*
