...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [receiptor-ai-receiptor-mcp](https://smithery.ai/server/receiptor-ai/receiptor-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/receiptor-ai-receiptor-mcp.json)*
