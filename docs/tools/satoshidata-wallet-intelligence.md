...
**Description:**
Tool set changed silently at vsmithery: 14 tool(s) added, 44 tool(s) removed without a version bump.
...
**Description:**
input parameter "include_tokens" accepts a credential (informational; not evidence of insecure handling)
