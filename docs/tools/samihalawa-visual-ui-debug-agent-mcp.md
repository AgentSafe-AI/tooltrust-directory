...
**Description:**
Tool set changed silently at v1.0.1: 35 tool(s) added, 4 tool(s) removed without a version bump.
...
**Description:**
input parameter "sessionToken" appears to accept a secret or credential
...
**Description:**
input parameter "tokenNamespace" appears to accept a secret or credential
