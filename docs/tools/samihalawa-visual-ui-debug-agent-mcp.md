...
**Description:**
Tool set changed silently at v1.0.1: 35 tool(s) added, 1 tool(s) removed without a version bump.
...
**Description:**
input parameter "sessionToken" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "tokenNamespace" accepts a credential (informational; not evidence of insecure handling)
