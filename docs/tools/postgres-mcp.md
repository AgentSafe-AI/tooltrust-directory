...
**Description:**
tool name "describe_self" implies read-only operation but declares exec permission
...
**Description:**
possible prompt injection detected in tool description: pattern matched: (?i)(developer|unrestricted)\s+mode
...
**Description:**
tool name "list_databases" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_repack_status" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_role_ddl" implies read-only operation but declares exec permission
