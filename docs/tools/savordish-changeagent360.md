...
**Description:**
tool name "get_career_radar_scores" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/savordish-changeagent360.json)*
