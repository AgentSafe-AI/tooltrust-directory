# 🟠 argotdev-tutor-mcp-python

| Field | Value |
|-------|-------|
| **Grade** | **C** |
| **Risk Score** | 25 |
| **Version** | `sha-72d19c4c2776` |
| **Vendor** | argotdev |
| **Language** | Python |
| **Source** | [argotdev-tutor-mcp-python](https://github.com/argotdev/tutor-mcp-python) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/argotdev-tutor-mcp-python.json)*
