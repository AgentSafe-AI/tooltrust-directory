...
**Description:**
Tool set changed silently at v3.24.1: 2 tool(s) added, 0 tool(s) removed without a version bump.
...
**Description:**
input parameter "byApiKey" accepts a credential (informational; not evidence of insecure handling)
