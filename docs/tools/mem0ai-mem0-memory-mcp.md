...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [mem0ai-mem0-memory-mcp](https://smithery.ai/server/mem0ai/mem0-memory-mcp) |
...
**Description:**
Tool set changed silently at vsmithery: 15 tool(s) added, 9 tool(s) removed without a version bump.
...
**Description:**
tool name "get_strategy_performance" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mem0ai-mem0-memory-mcp.json)*
