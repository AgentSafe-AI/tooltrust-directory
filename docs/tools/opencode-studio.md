...
**Description:**
Tool set changed silently at v2.4.4: 8 tool(s) added, 5 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/opencode-studio.json)*
