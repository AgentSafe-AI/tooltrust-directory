...
**Description:**
Tool set changed silently at vmcp-framework-v0.2.22: 10 tool(s) added, 3 tool(s) removed without a version bump.
...
**Description:**
tool name "fetch_working_example" implies read-only operation but declares exec permission
...
**Description:**
tool name "list_known_deprecations" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-framework.json)*
