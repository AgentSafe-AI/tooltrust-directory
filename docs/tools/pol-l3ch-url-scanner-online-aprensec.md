...
Returns a full security report including:
  ...
  - WHOIS registration data (registrar, dates, country)
  - Full redirect chain analysis
  - AI-generated summary

Free to use. No account required. 10 scans/day per IP.
...
**Description:**
Tool set changed silently at vsmithery: 2 tool(s) added, 6 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/pol-l3ch-url-scanner-online-aprensec.json)*
