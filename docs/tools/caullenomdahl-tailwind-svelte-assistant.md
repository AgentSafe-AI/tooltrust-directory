...
| **Stars** | ⭐ 10 |
| **npm Package** | `tailwind-svelte-assistant-mcp-server` |
| **Language** | TypeScript |
| **Source** | [caullenomdahl-tailwind-svelte-assistant](https://github.com/CaullenOmdahl/Tailwind-Svelte-Assistant) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/caullenomdahl-tailwind-svelte-assistant.json)*
