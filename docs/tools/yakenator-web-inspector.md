...
**Description:**
Tool set changed silently at vsmithery: 5 tool(s) added, 2 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/yakenator-web-inspector.json)*
