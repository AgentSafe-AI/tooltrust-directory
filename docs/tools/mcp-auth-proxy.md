...
**Description:**
Tool set changed silently at v2.10.2: 19 tool(s) added, 1 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-auth-proxy.json)*
