...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [notion](https://smithery.ai/server/notion) |
...
**Description:**
Tool set changed silently at vsmithery: 25 tool(s) added, 12 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/notion.json)*
