...
**Description:**
Tool set changed silently at vsmithery: 25 tool(s) added, 8 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/fouldomain-phish-analytics.json)*
