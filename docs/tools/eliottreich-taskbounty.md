...
Tools (11):
  Poster: create_bounty_draft, fund_bounty, list_my_bounties, get_bounty_submissions, award_bounty, cancel_bounty
  Solver: list_open_bounties, get_bounty_detail, request_repo_access, submit_pr, check_submission_status
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [eliottreich-taskbounty](https://smithery.ai/server/eliottreich/taskbounty) |
...
**Description:**
tool name "get_bounty_detail" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/eliottreich-taskbounty.json)*
