...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [cherkavskyi-memplato](https://smithery.ai/server/cherkavskyi/memplato) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/cherkavskyi-memplato.json)*
