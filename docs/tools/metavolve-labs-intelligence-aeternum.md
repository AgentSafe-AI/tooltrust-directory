...
**Description:**
Tool set changed silently at vsmithery: 30 tool(s) added, 14 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/metavolve-labs-intelligence-aeternum.json)*
