...
**Description:**
tool name "get_threat_profile" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_rehab_profile" implies read-only operation but declares exec permission
