...
> Create long-form (faceless YouTube) videos end to end from any MCP client: script, locked character references, storyboard, voiceover, and final video editing — with characters and style held consistent across every shot.
...
**Description:**
tool name "set_provider_key" implies local write operation but only remote/network-class permissions were detected
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/framesail-framesail.json)*
