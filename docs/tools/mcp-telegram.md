...
**Description:**
Tool set changed silently at v0.1.1: 27 tool(s) added, 8 tool(s) removed without a version bump.
...
**Description:**
input parameter "secret_token" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-telegram.json)*
