...
**Description:**
Tool set changed silently at v1.2.2: 8 tool(s) added, 4 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/one-search-mcp.json)*
