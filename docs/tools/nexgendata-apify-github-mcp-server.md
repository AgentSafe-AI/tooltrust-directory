...
**Description:**
Tool set changed silently at vsmithery: 86 tool(s) added, 4 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nexgendata-apify-github-mcp-server.json)*
