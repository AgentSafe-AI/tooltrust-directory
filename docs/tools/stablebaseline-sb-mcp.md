...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [stablebaseline-sb-mcp](https://smithery.ai/server/stablebaseline/sb-mcp) |
...
**Description:**
input parameter "quote_token" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/stablebaseline-sb-mcp.json)*
