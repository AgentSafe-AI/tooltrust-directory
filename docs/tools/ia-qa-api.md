...
Use IA-QA's developer tools to test your llm agents RAG ai tools, directly from Cursor, Claude Desktop, Windsurf, or any AI agent without leaving your IDE. 
Many classical testing tools too ! Enjoy ! 
...
**Description:**
input parameter "chunk_tokens" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "max_output_tokens" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "max_context_tokens" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "tokens_per_day" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "api_keys" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
tool name "get_testing_guidelines" implies read-only operation but declares exec permission
...
**Description:**
input parameter "confluence_token" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ia-qa-api.json)*
