...
**Description:**
Tool set changed silently at v0.2.1: 28 tool(s) added, 5 tool(s) removed without a version bump.
...
**Description:**
input parameter "publicToken" accepts a credential (informational; not evidence of insecure handling)
