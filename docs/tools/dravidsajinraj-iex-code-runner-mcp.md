# 🟠 dravidsajinraj-iex-code-runner-mcp

> Used to run the python and 
...
| **Risk Score** | 25 |
| **Version** | `1.0.0` |
| **Vendor** | dravidsajinraj-iex |
| **npm Package** | `code-runner-mcp` |
| **Language** | TypeScript |
| **Source** | [dravidsajinraj-iex-code-runner-mcp](https://github.com/dravidsajinraj-iex/code-runner-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/dravidsajinraj-iex-code-runner-mcp.json)*
