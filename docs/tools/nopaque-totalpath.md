...
> Map and test phone IVR systems via API. TotalPath discovers menu trees with real calls, runs scripted persona tests, executes regulatory compliance probes, and orchestrates concurrent load tests at scale — all with AI-graded transcripts. Authenticate with a workspace API key from https://nopaque.co.uk/account/api-keys.
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [nopaque-totalpath](https://smithery.ai/server/nopaque/totalpath) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nopaque-totalpath.json)*
