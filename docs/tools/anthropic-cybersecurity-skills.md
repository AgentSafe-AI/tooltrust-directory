...
**Description:**
Tool set changed silently at v1.3.0: 16 tool(s) added, 3 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/anthropic-cybersecurity-skills.json)*
