...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [axiora-japan-financials](https://smithery.ai/server/axiora/japan-financials) |
...
**Description:**
tool name "get_buybacks" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_board_composition" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/axiora-japan-financials.json)*
