...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [powersun-merx](https://smithery.ai/server/powersun/merx) |
...
**Description:**
input parameter "to_token" appears to accept a secret or credential
...
**Description:**
input parameter "from_token" appears to accept a secret or credential
...
**Description:**
input parameter "private_key" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/powersun-merx.json)*
