...
**Description:**
Tool set changed silently at vsmithery: 13 tool(s) added, 37 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/boar-network-blockchain-basic.json)*
