...
**Description:**
tool name "read_notebook" implies read-only operation but declares exec permission
...
**Description:**
tool name "read_cell" implies read-only operation but declares exec permission
...
**Description:**
input parameter "jupyter_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "proxy_token" accepts a credential (informational; not evidence of insecure handling)
