...
**Description:**
input parameter "reply_token" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/node2flow-line-bot.json)*
