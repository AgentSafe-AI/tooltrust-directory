...
**Description:**
tool name "createTestInclude" duplicates "createTestInclude" already registered in this tool set — a malicious server can shadow a trusted tool by registering an identical name
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mario-andreschak-mcp-abap-abap-adt-api.json)*
