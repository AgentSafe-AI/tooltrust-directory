...
**Description:**
Tool set changed silently at v1.7.9: 3 tool(s) added, 10 tool(s) removed without a version bump.
...
**Description:**
tool name "get_company_detail" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/registry.json)*
