...
**Description:**
Tool set changed silently at v1.8.1: 10 tool(s) added, 36 tool(s) removed without a version bump.
...
**Description:**
tool name "fetch_document" implies read-only operation but declares exec permission
