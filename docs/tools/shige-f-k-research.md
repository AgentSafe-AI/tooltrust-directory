...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [shige-f-k-research](https://smithery.ai/server/shige-f-k/research) |
...
**Description:**
tool name "list_service" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/shige-f-k-research.json)*
