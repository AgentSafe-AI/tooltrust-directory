...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [hugeicons-mcp-server](https://smithery.ai/server/hugeicons/mcp-server) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/hugeicons-mcp-server.json)*
