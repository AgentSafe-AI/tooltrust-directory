...
**Description:**
Tool set changed silently at v1.0.26: 18 tool(s) added, 14 tool(s) removed without a version bump.
...
**Description:**
tool name "get_wwdc_video" implies read-only operation but declares exec permission
