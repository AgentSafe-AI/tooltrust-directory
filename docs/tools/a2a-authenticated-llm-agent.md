...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [a2a-authenticated-llm-agent](https://smithery.ai/server/a2a/authenticated-llm-agent) |
...
**Description:**
Tool set changed silently at vsmithery: 11 tool(s) added, 1 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/a2a-authenticated-llm-agent.json)*
