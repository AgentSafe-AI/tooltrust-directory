...
**Description:**
Tool set changed silently at v2.1.0: 17 tool(s) added, 15 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ios-simulator-mcp.json)*
