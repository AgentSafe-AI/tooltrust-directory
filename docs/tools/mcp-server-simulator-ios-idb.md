...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-8r9q-7v3j-jr4g in @modelcontextprotocol/sdk@1.6.1

**Severity:** Medium

**Description:**
GHSA-8r9q-7v3j-jr4g in @modelcontextprotocol/sdk@1.6.1 (npm ecosystem).
...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-w48q-cv73-mx4w in @modelcontextprotocol/sdk@1.6.1

**Severity:** Medium

**Description:**
GHSA-w48q-cv73-mx4w in @modelcontextprotocol/sdk@1.6.1 (npm ecosystem).
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-server-simulator-ios-idb.json)*
