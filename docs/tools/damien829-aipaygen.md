...
> Open-source MCP server with 250+ AI tools. Research, code, scrape, translate, analyze. 15 models, 7 providers. pip install aipaygen-mcp
...
| **Stars** | ⭐ 1 |
| **Language** | Python |
| **Source** | [damien829-aipaygen](https://github.com/Damien829/aipaygen) |
...
**Description:**
tool name "search_skills" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_agent_runs" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/damien829-aipaygen.json)*
