...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [octomil-octomil](https://smithery.ai/server/octomil/octomil) |
...
**Description:**
input parameter "n_tokens" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/octomil-octomil.json)*
