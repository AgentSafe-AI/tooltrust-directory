...
**Description:**
Tool set changed silently at v0.1.21: 1278 tool(s) added, 7 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/agent-qa.json)*
