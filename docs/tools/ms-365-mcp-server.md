...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-345p-7cg4-v4c7 in @modelcontextprotocol/sdk@1.25.0

**Severity:** Medium

**Description:**
GHSA-345p-7cg4-v4c7 in @modelcontextprotocol/sdk@1.25.0 (npm ecosystem).
...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-8r9q-7v3j-jr4g in @modelcontextprotocol/sdk@1.25.0

**Severity:** Medium

**Description:**
GHSA-8r9q-7v3j-jr4g in @modelcontextprotocol/sdk@1.25.0 (npm ecosystem).
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ms-365-mcp-server.json)*
