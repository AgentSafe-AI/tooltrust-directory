...
**Description:**
Tool set changed silently at v1.1.2: 16 tool(s) added, 1 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/solana-mcp-vybe.json)*
