...
**Description:**
Tool set changed silently at v3.1.1: 4 tool(s) added, 4 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-server-typescript.json)*
