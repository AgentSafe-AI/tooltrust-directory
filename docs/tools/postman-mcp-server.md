...
**Description:**
declared capabilities: code/command execution, environment variables
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/postman-mcp-server.json)*
