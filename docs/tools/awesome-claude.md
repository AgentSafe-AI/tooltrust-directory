...
**Description:**
Tool set changed silently at vmcp-v0.14.9: 27 tool(s) added, 4 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/awesome-claude.json)*
