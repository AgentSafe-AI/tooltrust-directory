...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [canonical-ai-company-search](https://smithery.ai/server/canonical-ai/company-search) |
...
**Description:**
tool name "search_companies" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_company_details" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/canonical-ai-company-search.json)*
