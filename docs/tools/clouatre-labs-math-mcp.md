...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [clouatre-labs-math-mcp](https://smithery.ai/server/clouatre-labs/math-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/clouatre-labs-math-mcp.json)*
