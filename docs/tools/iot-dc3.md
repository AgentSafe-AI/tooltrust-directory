...
**Description:**
Tool set changed silently at v2026.9.22: 14 tool(s) added, 57 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/iot-dc3.json)*
