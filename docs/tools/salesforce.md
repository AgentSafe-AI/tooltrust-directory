...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [salesforce](https://smithery.ai/server/salesforce) |
...
**Description:**
input parameter "add_threading_tokens" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/salesforce.json)*
