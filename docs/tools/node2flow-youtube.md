...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [node2flow-youtube](https://smithery.ai/server/node2flow/youtube) |
...
**Description:**
Tool set changed silently at vsmithery: 20 tool(s) added, 16 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/node2flow-youtube.json)*
