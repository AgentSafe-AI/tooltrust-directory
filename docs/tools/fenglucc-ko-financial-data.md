...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [fenglucc-ko-financial-data](https://smithery.ai/server/fenglucc/ko-financial-data) |
...
**Description:**
Tool set changed silently at vsmithery: 24 tool(s) added, 4 tool(s) removed without a version bump.
...
**Description:**
tool name "list_insider_traders" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/fenglucc-ko-financial-data.json)*
