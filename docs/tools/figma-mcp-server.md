...
**Description:**
Tool set changed silently at v1.0.0: 49 tool(s) added, 9 tool(s) removed without a version bump.
...
**Description:**
input parameter "plugin_payment_token" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/figma-mcp-server.json)*
