...
**Description:**
tool name "get_user_identity_by_subscription" implies read-only operation but declares exec permission
...
**Description:**
input schema exposes 34 properties (threshold: 10)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/onesignal-onesignal.json)*
