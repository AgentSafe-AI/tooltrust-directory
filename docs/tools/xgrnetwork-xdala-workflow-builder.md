...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [xgrnetwork-xdala-workflow-builder](https://smithery.ai/server/xgrnetwork/xdala-workflow-builder) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/xgrnetwork-xdala-workflow-builder.json)*
