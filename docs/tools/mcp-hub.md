...
**Description:**
Tool set changed silently at v4.2.1: 82 tool(s) added, 4 tool(s) removed without a version bump.
...
**Description:**
tool name "search_facilities" implies read-only operation but declares exec permission
...
**Description:**
input parameter "mpp_credential" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
tool name "get_news" implies read-only operation but declares exec permission
...
**Description:**
tool name "set_shortlist_alert" implies local write operation but only remote/network-class permissions were detected
...
**Description:**
tool name "get_energy_prices" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_renewable_energy" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_water_risk" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-hub.json)*
