...
Funciona em qualquer cliente MCP. Servidor remoto: `https://api.mcp.ai/p_ifood`
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [mcp-dir-ifood-mcp](https://smithery.ai/server/mcp-dir/ifood-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-dir-ifood-mcp.json)*
