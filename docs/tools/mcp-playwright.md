...
**Description:**
Tool set changed silently at v1.0.12: 33 tool(s) added, 6 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-playwright.json)*
