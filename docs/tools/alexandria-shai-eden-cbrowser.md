...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [alexandria-shai-eden-cbrowser](https://smithery.ai/server/alexandria-shai-eden/cbrowser) |
...
**Description:**
input parameter "_browserToken" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "oauthToken" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
tool name "set_api_key" implies local write operation but only remote/network-class permissions were detected
...
**Description:**
input parameter "proxy_password" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/alexandria-shai-eden-cbrowser.json)*
