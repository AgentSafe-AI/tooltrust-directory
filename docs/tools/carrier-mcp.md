...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [carrier-mcp](https://smithery.ai/server/carrier/mcp) |
...
**Description:**
tool name "set_subscriber_traffic_restrictions" implies local write operation but only remote/network-class permissions were detected
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/carrier-mcp.json)*
