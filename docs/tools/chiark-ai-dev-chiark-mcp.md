...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [chiark-ai-dev-chiark-mcp](https://smithery.ai/server/chiark-ai-dev/chiark-mcp) |
...
**Description:**
tool name "find_agent" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/chiark-ai-dev-chiark-mcp.json)*
