...
**Description:**
Tool set changed silently at v1.4.0: 6 tool(s) added, 9 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/meigen-ai-design-mcp.json)*
