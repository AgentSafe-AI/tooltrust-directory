...
**Description:**
Tool set changed silently at v6.7.5: 8 tool(s) added, 29 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/arc-kit.json)*
