...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [axel-belfort-diff-checker](https://smithery.ai/server/axel-belfort/diff-checker) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/axel-belfort-diff-checker.json)*
