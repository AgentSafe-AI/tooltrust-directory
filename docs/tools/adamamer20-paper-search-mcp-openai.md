...
**Description:**
Tool set changed silently at vsmithery: 0 tool(s) added, 24 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/adamamer20-paper-search-mcp-openai.json)*
