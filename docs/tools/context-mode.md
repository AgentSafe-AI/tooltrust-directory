...
**Description:**
Tool set changed silently at v1.0.169: 2 tool(s) added, 11 tool(s) removed without a version bump.
...
**Description:**
input parameter "maxTokenBudget" accepts a credential (informational; not evidence of insecure handling)
