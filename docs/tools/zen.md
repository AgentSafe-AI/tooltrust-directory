...
**Description:**
Tool set changed silently at v1.5.0: 44 tool(s) added, 1 tool(s) removed without a version bump.
...
**Description:**
input parameter "refresh_token" accepts a credential (informational; not evidence of insecure handling)
