...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [city24-city24-lv-real-estate](https://smithery.ai/server/city24/city24-lv-real-estate) |
...
**Description:**
Tool set changed silently at vsmithery: 1 tool(s) added, 23 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/city24-city24-lv-real-estate.json)*
