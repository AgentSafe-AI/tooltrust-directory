...
**Description:**
Tool set changed silently at v1.0.6: 6 tool(s) added, 2 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/yokingma-time-mcp.json)*
