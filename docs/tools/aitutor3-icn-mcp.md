...
**Description:**
tool name "get_departure_congestion" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_parking_status" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/aitutor3-icn-mcp.json)*
