...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [virtualsms-virtualsms-mcp](https://smithery.ai/server/virtualsms/virtualsms-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/virtualsms-virtualsms-mcp.json)*
