...
**Description:**
Tool set changed silently at v1.4.2: 75 tool(s) added, 4 tool(s) removed without a version bump.
...
**Description:**
tool name "get_effective_permissions" implies read-only operation but declares exec permission
