...
**Description:**
Tool set changed silently at v1.3.4: 30 tool(s) added, 35 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/stanislavlysenko0912-todoist-mcp-server.json)*
