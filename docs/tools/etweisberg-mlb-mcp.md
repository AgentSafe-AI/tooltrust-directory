...
**Description:**
Tool set changed silently at vsmithery: 46 tool(s) added, 1 tool(s) removed without a version bump.
...
**Description:**
Tool 'get_stats' has no description - agents cannot reason about its purpose, and static analysis coverage is limited
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/etweisberg-mlb-mcp.json)*
