...
**Description:**
Tool set changed silently at v2.6.10: 8 tool(s) added, 253 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/imbenrabi-financial-modeling-prep-mcp-server.json)*
