...
**Description:**
Tool set changed silently at vsmithery: 27 tool(s) added, 7 tool(s) removed without a version bump.
...
**Description:**
tool name "get_swap_quote" implies read-only operation but declares exec permission
...
**Description:**
tool name "get_auto_action_history" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/powersun-tron-energy-mcp.json)*
