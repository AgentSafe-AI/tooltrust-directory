...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [postify-postify-mcp](https://smithery.ai/server/postify/postify-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/postify-postify-mcp.json)*
