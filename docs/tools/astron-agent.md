...
**Description:**
Tool set changed silently at v1.0.9: 1278 tool(s) added, 6 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/astron-agent.json)*
