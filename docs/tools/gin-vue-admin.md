...
**Description:**
Tool set changed silently at v3.0.0: 6 tool(s) added, 16 tool(s) removed without a version bump.
...
**Description:**
input parameter "server_token" accepts a credential (informational; not evidence of insecure handling)
