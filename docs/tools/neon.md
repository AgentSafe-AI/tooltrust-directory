...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [neon](https://smithery.ai/server/neon) |
...
**Description:**
tool name "list_slow_queries" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/neon.json)*
