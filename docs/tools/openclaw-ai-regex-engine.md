...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [openclaw-ai-regex-engine](https://smithery.ai/server/openclaw-ai/regex-engine) |
...
**Description:**
Tool set changed silently at vsmithery: 12 tool(s) added, 29 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/openclaw-ai-regex-engine.json)*
