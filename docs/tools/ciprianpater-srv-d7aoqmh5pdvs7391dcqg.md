...
**Description:**
input parameter "api_key_hash" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/ciprianpater-srv-d7aoqmh5pdvs7391dcqg.json)*
