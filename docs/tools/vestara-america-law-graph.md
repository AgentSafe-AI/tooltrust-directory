...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [vestara-america-law-graph](https://smithery.ai/server/vestara/america-law-graph) |
...
**Description:**
tool name "get_risk_surface" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/vestara-america-law-graph.json)*
