...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [agentpact-marketplace](https://smithery.ai/server/agentpact/marketplace) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/agentpact-marketplace.json)*
