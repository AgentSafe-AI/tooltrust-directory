...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [nexbid-agentic-commerce](https://smithery.ai/server/nexbid/agentic_commerce) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/nexbid-agentic-commerce.json)*
