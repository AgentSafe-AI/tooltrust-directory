...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [siimaster-siimaster](https://smithery.ai/server/siimaster/siimaster) |
...
**Description:**
input parameter "password_sii" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "token_sii" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/siimaster-siimaster.json)*
