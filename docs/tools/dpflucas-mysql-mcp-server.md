...
**Description:**
Tool set changed silently at v0.1.3: 3 tool(s) added, 2 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/dpflucas-mysql-mcp-server.json)*
