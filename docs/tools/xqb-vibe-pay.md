...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [xqb-vibe-pay](https://smithery.ai/server/xqb/vibe-pay) |
...
**Description:**
input parameter "new_token_input" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/xqb-vibe-pay.json)*
