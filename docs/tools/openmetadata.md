...
**Description:**
Tool set changed silently at v1.2.1: 12 tool(s) added, 9 tool(s) removed without a version bump.
...
**Description:**
tool name "get_audio_features" implies read-only operation but declares exec permission
