...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [primitivedotdev-primitive](https://smithery.ai/server/primitivedotdev/primitive) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/primitivedotdev-primitive.json)*
