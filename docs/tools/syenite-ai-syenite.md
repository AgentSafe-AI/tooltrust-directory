...
> Composable DeFi intelligence for AI agents — lending rates and execution, yield, swap and bridge, prediction markets, position alerts with webhooks, wallet ops, and gas estimation across 30+ chains via MCP.
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [syenite-ai-syenite](https://smithery.ai/server/syenite-ai/syenite) |
...
**Description:**
declared capabilities: code/command execution, network access, database access, HTTP requests
...
**Description:**
declared capabilities: code/command execution, database access, HTTP requests
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/syenite-ai-syenite.json)*
