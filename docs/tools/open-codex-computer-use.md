...
**Description:**
Tool set changed silently at v0.3.1: 5 tool(s) added, 6 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/open-codex-computer-use.json)*
