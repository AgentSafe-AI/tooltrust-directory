...
**Description:**
Tool set changed silently at v0.3.5: 63 tool(s) added, 6 tool(s) removed without a version bump.
...
**Description:**
declared capabilities: network access, environment variables, HTTP requests
