...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [sentinelsignal-verify](https://smithery.ai/server/sentinelsignal/verify) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/sentinelsignal-verify.json)*
