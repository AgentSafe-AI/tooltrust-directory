...
> Google Drive MCP server for file management and document access.
...
**Description:**
Tool set changed silently at vsmithery: 18 tool(s) added, 20 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/googledrive.json)*
