...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [zeintesit-forkit](https://smithery.ai/server/zeintesit/forkit) |
...
**Description:**
tool name "search_api" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/zeintesit-forkit.json)*
