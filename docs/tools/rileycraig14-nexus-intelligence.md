...
**Description:**
tool name "find_agent_capability" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/rileycraig14-nexus-intelligence.json)*
