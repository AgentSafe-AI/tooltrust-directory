...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-345p-7cg4-v4c7 in @modelcontextprotocol/sdk@1.24.1

**Severity:** Medium

**Description:**
GHSA-345p-7cg4-v4c7 in @modelcontextprotocol/sdk@1.24.1 (npm ecosystem).
...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-8r9q-7v3j-jr4g in @modelcontextprotocol/sdk@1.24.1

**Severity:** Medium

**Description:**
GHSA-8r9q-7v3j-jr4g in @modelcontextprotocol/sdk@1.24.1 (npm ecosystem).
...
### 🟡 📦 `AS-004` — Supply Chain CVE: GHSA-43fc-jf86-j433 in axios@1.12.0

**Severity:** Medium

**Description:**
GHSA-43fc-jf86-j433 in axios@1.12.0 (npm ecosystem).
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-openapi-server.json)*
