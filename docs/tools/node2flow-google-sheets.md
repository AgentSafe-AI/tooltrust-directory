...
- `GOOGLE_REFRESH_TOKEN` : Refresh token with spreadsheets scope
...
**Description:**
Tool set changed silently at vsmithery: 23 tool(s) added, 33 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/node2flow-google-sheets.json)*
