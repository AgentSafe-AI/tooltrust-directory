...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [timergy-timergy](https://smithery.ai/server/timergy/timergy) |
...
**Description:**
input parameter "passphrase" appears to accept a secret or credential
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/timergy-timergy.json)*
