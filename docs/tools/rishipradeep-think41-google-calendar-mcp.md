...
| **Risk Score** | 27 |
| **Version** | `1.0.0` |
| **Vendor** | rishipradeep-think41 |
| **npm Package** | `google-calendar-mcp` |
| **npm Downloads (30d)** | 1.1k |
| **Language** | JavaScript |
| **Source** | [rishipradeep-think41-google-calendar-mcp](https://github.com/rishipradeep-think41/google-calendar-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/rishipradeep-think41-google-calendar-mcp.json)*
