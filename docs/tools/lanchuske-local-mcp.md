...
**Description:**
Tool set changed silently at vsmithery: 15 tool(s) added, 7 tool(s) removed without a version bump.
...
**Description:**
input parameter "api_token" accepts a credential (informational; not evidence of insecure handling)
...
**Description:**
input parameter "skill_token" accepts a credential (informational; not evidence of insecure handling)
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/lanchuske-local-mcp.json)*
