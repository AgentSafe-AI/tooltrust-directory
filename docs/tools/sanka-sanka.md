...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [sanka-sanka](https://smithery.ai/server/sanka/sanka) |
...
**Description:**
tool name "get_subscription" implies read-only operation but declares exec permission
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/sanka-sanka.json)*
