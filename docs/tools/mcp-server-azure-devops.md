...
**Description:**
tool name "get_pull_request" implies read-only operation but declares network permission
...
**Description:**
tool name "get_pull_request_changes" implies read-only operation but declares network permission
