...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [jonathan-7udh-inferventis-finance](https://smithery.ai/server/jonathan-7udh/inferventis-finance) |
...
**Description:**
Tool set changed silently at vsmithery: 25 tool(s) added, 19 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/jonathan-7udh-inferventis-finance.json)*
