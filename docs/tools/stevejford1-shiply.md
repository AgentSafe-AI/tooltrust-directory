...
> A remote MCP server that hosts your site, not just the MCP. Publish a static site
   from Claude Code, Cursor, or any AI agent in one call — no account, no CLI, no
   GitHub, a live URL. Add custom domains, SSL, databases, and edge functions, or
   sell the site you built. Flat price, no usage meter.
...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [stevejford1-shiply](https://smithery.ai/server/stevejford1/shiply) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/stevejford1-shiply.json)*
