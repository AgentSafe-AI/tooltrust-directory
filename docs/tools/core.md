...
**Description:**
Tool set changed silently at v3.9.0: 2 tool(s) added, 11 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/core.json)*
