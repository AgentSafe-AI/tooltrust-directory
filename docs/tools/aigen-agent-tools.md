...
**Description:**
Tool set changed silently at vsmithery: 1278 tool(s) added, 37 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/aigen-agent-tools.json)*
