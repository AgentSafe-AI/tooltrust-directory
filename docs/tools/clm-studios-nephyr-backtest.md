...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [clm-studios-nephyr-backtest](https://smithery.ai/server/clm-studios/nephyr-backtest) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/clm-studios-nephyr-backtest.json)*
