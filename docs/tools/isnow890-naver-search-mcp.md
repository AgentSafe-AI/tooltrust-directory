...
**Description:**
Tool set changed silently at v1.0.47: 2 tool(s) added, 0 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/isnow890-naver-search-mcp.json)*
