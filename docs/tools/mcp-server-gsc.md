...
**Description:**
Tool set changed silently at v0.3.0: 17 tool(s) added, 8 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/mcp-server-gsc.json)*
