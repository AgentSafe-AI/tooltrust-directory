...
The AI builds incrementally while a live preview URL updates in real time. When you're done, a single publish_form call returns an editor link to claim full ownership on the Weavely platform.
No authentication required. After publishing, connect your form to Google Sheets, Zapier, n8n, HubSpot, Notion, and more.
...
**Description:**
tool name "set_logic" implies local write operation but only remote/network-class permissions were detected
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/florian-weavely.json)*
