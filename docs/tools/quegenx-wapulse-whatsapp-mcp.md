...
| **Version** | `smithery` |
| **Vendor** | Smithery |
| **Source** | [quegenx-wapulse-whatsapp-mcp](https://smithery.ai/server/Quegenx/wapulse-whatsapp-mcp) |
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/quegenx-wapulse-whatsapp-mcp.json)*
