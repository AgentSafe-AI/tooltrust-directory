...
**Description:**
Tool set changed silently at v2.0.0: 8 tool(s) added, 7 tool(s) removed without a version bump.
...
*Scored using [ToolTrust methodology](../methodology.md) · [Raw JSON report](../../data/reports/pagespeed-insights-mcp.json)*
