...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1389-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--06--24-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1389 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.76` | 22.2M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Jun 24 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 10.5M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Jun 24 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.4` | 6.8M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Jun 24 |
| [upstash-context7-mcp](https://github.com/upstash/context7) | `1.0.30` | 4.5M/mo | **[A](./docs/tools/upstash-context7-mcp.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Jun 24 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.5M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Jun 24 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.48.0-pre…` | 2.8M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Jun 24 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 1.1M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Jun 24 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 604.4k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Jun 24 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.59.4` | 522.8k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Jun 24 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 458.3k/mo | **[C](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×25, `AS-014` ×26, ⚡ `AS-006` | Jun 24 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.4.1` | 439.8k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Jun 24 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 414.7k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Jun 24 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 413.1k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Jun 24 |
...
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.20` | 178.1k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Jun 24 |
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 169.1k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Jun 24 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.16.2` | 128.4k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×12, `AS-014` ×17, 📐 `AS-003` ×2 | Jun 24 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.128.1` | 120.0k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×183, 🔑 `AS-002` ×224, ⚡ `AS-011` ×177 | Jun 24 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `3.9.2` | 118.7k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Jun 24 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.42` | 115.2k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Jun 24 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.1` | 103.4k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Jun 24 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 101.3k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Jun 24 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.166` | 101.2k/mo | **[A](./docs/tools/context-mode.md)** | `AS-014` ×11, 🔑 `AS-002` | Jun 24 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.8.0` | 92.8k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Jun 24 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 87.6k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Jun 24 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 80.0k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Jun 24 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.60` | 78.8k/mo | **[A](./docs/tools/mobile-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×5, ⚡ `AS-011` | Jun 24 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.11.3` | 74.9k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Jun 24 |
| [magic-mcp](https://github.com/21st-dev/magic-mcp) | `0.1.1-beta.1` | 69.6k/mo | **[A](./docs/tools/magic-mcp.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` ×2 | Jun 24 |
...
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.0.85` | 60.8k/mo | **[B](./docs/tools/brave-search-mcp-server.md)** | `AS-012`, `AS-014` ×5, 🔑 `AS-002` ×2, ⚡ `AS-011` ×2 | Jun 24 |
| [mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) | `3.0.0` | 58.5k/mo | **[A](./docs/tools/mcp-server-browserbase.md)** | `AS-014` ×6, 🔑 `AS-002`, ⚡ `AS-011` | Jun 24 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.5.0` | 56.2k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Jun 24 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.27.0` | 48.6k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Jun 24 |
| [kong](https://github.com/Kong/kong) | `3.9.3` | 43.7k | **[A](./docs/tools/kong.md)** | `AS-014` | Jun 24 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 38.7k | **[B](./docs/tools/agent-reach.md)** | `AS-012`, 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×7 | Jun 24 |
| [browsermcp](https://github.com/browsermcp/mcp) | `0.1.3` | 36.1k/mo | **[A](./docs/tools/browsermcp.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×12 | Jun 24 |
...
| [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | `2.11.0` | 32.8k/mo | **[A](./docs/tools/brightdata-mcp.md)** | 🔑 `AS-002` ×60, ⚡ `AS-011` ×58, `AS-014` ×65 | Jun 24 |
| [github-mcp-server](https://github.com/github/github-mcp-server) | `1.4.0` | 30.9k | **[B](./docs/tools/github-mcp-server.md)** | 🔑 `AS-002` ×52, ⚡ `AS-011` ×36, `AS-014` ×86, 📐 `AS-003`, 🗝️ `AS-010` | Jun 24 |
