...
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--08--19-blue)](./data/reports/)
...
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 196.0M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Aug 19 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.79` | 25.4M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Aug 19 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 11.6M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Aug 19 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 7.5M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Aug 19 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.6M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Aug 19 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 1.9M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Aug 19 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.56.0-pre…` | 1.8M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Aug 19 |
| [editor](https://github.com/pascalorg/editor) | `1.0.0-beta.1` | 1.7M/mo | **[A](./docs/tools/editor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×5 | Aug 19 |
...
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 753.3k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Aug 19 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.72.0` | 590.1k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Aug 19 |
| [agent-device](https://github.com/callstack/agent-device) | `0.20.10` | 563.8k/mo | **[A](./docs/tools/agent-device.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×6, `AS-014` ×11 | Aug 19 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 548.7k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Aug 19 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 522.5k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Aug 19 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 521.1k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Aug 19 |
...
| [azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp) | `2.9.0` | 449.3k/mo | **[B](./docs/tools/azure-devops-mcp.md)** | `AS-012`, 🔑 `AS-002` ×26, ⚡ `AS-011` ×13, `AS-014` ×32 | Aug 19 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 347.2k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 19 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `weaken-too…` | 293.4k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×23, 🔑 `AS-002`, ⚡ `AS-011` | Aug 19 |
...
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 231.9k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Aug 19 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.47` | 229.9k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Aug 19 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.145.0` | 159.7k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Aug 19 |
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 150.0k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Aug 19 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 142.6k/mo | **[C](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Aug 19 |
...
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.22` | 126.2k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Aug 19 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 106.2k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 19 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.2` | 97.7k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×5, `AS-014` ×27 | Aug 19 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.1` | 90.9k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 19 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 89.7k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Aug 19 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.14.3` | 87.0k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Aug 19 |
...
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.10.0` | 83.0k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 19 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.15.0` | 81.4k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×3, `AS-014` ×4 | Aug 19 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 79.8k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Aug 19 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.38.12` | 74.4k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Aug 19 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.4` | 73.7k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Aug 19 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 72.8k | **[A](./docs/tools/agent-reach.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×5, 🗝️ `AS-010` | Aug 19 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.35.0` | 66.8k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 19 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.7.1` | 58.4k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 19 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 51.1k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Aug 18 |
...
| [ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | `2026.08` | 47.1k | **[A](./docs/tools/ai-engineering-from-scratch.md)** | `AS-014` ×5, 🔑 `AS-002`, ⚡ `AS-011` | Aug 19 |
| [kong](https://github.com/Kong/kong) | `3.9.3` | 44.0k | **[A](./docs/tools/kong.md)** | `AS-014` | Aug 19 |
| [browsermcp](https://github.com/browsermcp/mcp) | `0.1.3` | 41.4k/mo | **[A](./docs/tools/browsermcp.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×12 | Aug 19 |
