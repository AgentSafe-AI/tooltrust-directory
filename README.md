...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-622-brightgreen)](./data/reports/)
...
*Top 50 by popularity. View all 622 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.36.0` | 3.2M/mo | **[C](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×35, ⚡ `AS-011` ×11 | Apr 3 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 2.8M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×3 | Apr 3 |
...
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `2026.1.26` | 448.2k/mo | **[C](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×35, ⚡ `AS-011` ×18 | Apr 3 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `2026.1.26` | 403.4k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | ✅ None | Apr 3 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.46.1` | 391.6k/mo | **[C](./docs/tools/n8n-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×2 | Apr 3 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.8.0` | 379.8k/mo | **[C](./docs/tools/figma-context-mcp.md)** | 🔑 `AS-002` ×13, 📐 `AS-003`, 🗝️ `AS-010`, ⚡ `AS-011` ×3, `AS-014` ×18 | Apr 3 |
| [tavily-ai-tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.18` | 307.6k/mo | **[C](./docs/tools/tavily-ai-tavily-mcp.md)** | 🔑 `AS-002` ×9, ⚡ `AS-011` ×4, `AS-014` ×4 | Apr 3 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.18` | 307.6k/mo | **[C](./docs/tools/tavily-mcp.md)** | `AS-012`, 🔑 `AS-002` ×11, ⚡ `AS-011` ×5, `AS-014` ×6, 🗝️ `AS-010` | Apr 3 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.1.0` | 274.4k/mo | **[C](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×22 | Apr 3 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `2026.1.26` | 123.8k/mo | **[C](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×14, ⚡ `AS-011` ×6, `AS-014` ×6 | Apr 3 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `task-maste…` | 94.0k/mo | **[A](./docs/tools/claude-task-master.md)** | `AS-014` ×7, 🔑 `AS-002` | Apr 3 |
...
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.38` | 73.7k/mo | **[C](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×22, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Apr 3 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.3.2` | 72.8k/mo | **[B](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×35, ⚡ `AS-011` ×3 | Apr 3 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.0` | 63.6k/mo | **[D](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×3, `AS-014` ×3, ⚡ `AS-006` | Apr 3 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.50` | 62.5k/mo | **[B](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` | Apr 3 |
| [marcopesani-mcp-server-serper](https://github.com/marcopesani/mcp-server-serper) | `0.2.0` | 61.2k/mo | **[C](./docs/tools/marcopesani-mcp-server-serper.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×2, `AS-014` ×2 | Apr 3 |
...
| [upstash-context7-mcp](https://github.com/upstash/context7) | `ctx7@0.3.9` | 51.6k | **[B](./docs/tools/upstash-context7-mcp.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Apr 3 |
...
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.0.75` | 35.9k/mo | **[C](./docs/tools/brave-search-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×14, ⚡ `AS-011` ×6, `AS-014` ×6 | Apr 3 |
| [mochow13-google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp) | `sha-258b00…` | 31.7k/mo | **[B](./docs/tools/mochow13-google-scholar-mcp.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` | Apr 3 |
...
| [mcp-server](https://github.com/mapbox/mcp-server) | `0.11.0` | 18.1k/mo | **[C](./docs/tools/mcp-server.md)** | 🔑 `AS-002` ×15, ⚡ `AS-011` ×6 | Apr 3 |
| [git-mcp-server](https://github.com/cyanheads/git-mcp-server) | `2.10.5` | 17.6k/mo | **[C](./docs/tools/git-mcp-server.md)** | 🔑 `AS-002` ×38, ⚡ `AS-011` ×8 | Apr 3 |
| [postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server) | `2.8.4` | 15.6k/mo | **[C](./docs/tools/postman-mcp-server.md)** | 🔑 `AS-002` ×53, ⚡ `AS-011` ×15, `AS-014` ×41 | Apr 3 |
| [mcp-server-asana](https://github.com/roychri/mcp-server-asana) | `1.6.0` | 14.4k/mo | **[C](./docs/tools/mcp-server-asana.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×3, `AS-014` ×10 | Apr 3 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `@repo/mcp-…` | 14.2k/mo | **[D](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Apr 3 |
| [airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) | `1.13.0` | 13.9k/mo | **[B](./docs/tools/airtable-mcp-server.md)** | `AS-014` ×13, 🔑 `AS-002` ×8, ⚡ `AS-011` | Apr 3 |
| [sirmews-mcp-remote-server](https://github.com/sirmews/mcp-remote-server) | `sha-b13964…` | 13.6k/mo | **[A](./docs/tools/sirmews-mcp-remote-server.md)** | `AS-014` | Apr 3 |
| [helloggx-shadcn-vue-mcp](https://github.com/HelloGGX/shadcn-vue-mcp) | `1.0.1` | 13.6k/mo | **[A](./docs/tools/helloggx-shadcn-vue-mcp.md)** | `AS-014` ×6 | Apr 3 |
...
| [mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) | `3.0.0` | 11.1k/mo | **[B](./docs/tools/mcp-server-browserbase.md)** | 🔑 `AS-002`, ⚡ `AS-011` | Apr 3 |
...
| [mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript) | `2.8.7` | 10.2k/mo | **[C](./docs/tools/mcp-server-typescript.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×13 | Apr 3 |
...
| [openmetadata](https://github.com/open-metadata/OpenMetadata) | `1.12.4-rel…` | 9.6k | **[B](./docs/tools/openmetadata.md)** | 🔑 `AS-002` ×2, `AS-014` ×2, ⚡ `AS-011` | Apr 3 |
