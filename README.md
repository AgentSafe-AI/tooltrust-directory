...
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.68` | 29.0k | **[A](./docs/tools/playwright-mcp.md)** | `AS-007` ×8 | Mar 16 |
| [ui-tars-desktop](https://github.com/bytedance/UI-TARS-desktop) | `0.3.0` | 28.9k | **[C](./docs/tools/ui-tars-desktop.md)** | `AS-006` ×2, `AS-007` ×60, ⚠️ `AS-002` ×6, `AS-011` ×6, `AS-003` | Mar 16 |
| [github-mcp-server](https://github.com/github/github-mcp-server) | `0.32.0` | 27.9k | **[C](./docs/tools/github-mcp-server.md)** | `AS-007` ×60, ⚠️ `AS-002` ×12, `AS-011` ×2 | Mar 16 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `task-maste…` | 25.9k | **[A](./docs/tools/claude-task-master.md)** | ⚠️ `AS-002` | Mar 16 |
| [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | `3.4.3` | 25.8k | **[B](./docs/tools/gpt-researcher.md)** | ⚠️ `AS-002` ×5, `AS-007` ×32, `AS-011` ×3 | Mar 16 |
| [serena](https://github.com/oraios/serena) | `0.1.4` | 21.6k | **[A](./docs/tools/serena.md)** | `AS-007` ×18 | Mar 16 |
| [activepieces](https://github.com/activepieces/activepieces) | `0.79.3` | 21.2k | **[B](./docs/tools/activepieces.md)** | ⚠️ `AS-002` ×8, `AS-011` ×2, `AS-007` ×60 | Mar 16 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.5.15` | 21.2k | **[B](./docs/tools/ruflo.md)** | ⚠️ `AS-002` ×12, `AS-011` ×8, `AS-007` ×60 | Mar 16 |
| [maxkb](https://github.com/1Panel-dev/MaxKB) | `2.6.1` | 20.3k | **[B](./docs/tools/maxkb.md)** | `AS-007` ×60, ⚠️ `AS-002`, `AS-011` | Mar 16 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.37.3` | 15.2k | **[B](./docs/tools/n8n-mcp.md)** | ⚠️ `AS-002` ×13, `AS-011` ×5, `AS-007` ×60 | Mar 16 |
| [trigger-dev](https://github.com/triggerdotdev/trigger.dev) | `4.4.3` | 14.0k | **[B](./docs/tools/trigger-dev.md)** | ⚠️ `AS-002` ×10, `AS-011` ×3, `AS-007` ×60 | Mar 16 |
...
| [xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server) | `0.9.2` | 8.9k | **[A](./docs/tools/xiaozhi-esp32-server.md)** | ⚠️ `AS-002` ×2, `AS-007` ×60 | Mar 16 |
| [mcp](https://github.com/awslabs/mcp) | `2026.03.20…` | 8.5k | **[A](./docs/tools/mcp.md)** | `AS-007` ×60, ⚠️ `AS-002` ×22 | Mar 16 |
| [ghidramcp](https://github.com/LaurieWired/GhidraMCP) | `1.4` | 7.9k | **[S 🌟](./docs/tools/ghidramcp.md)** | ✅ None | Mar 16 |
| [lamda](https://github.com/firerpa/lamda) | `9.20` | 7.7k | **[A](./docs/tools/lamda.md)** | `AS-007` ×3 | Mar 16 |
| [browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp) | `1.2.0` | 7.1k | **[B](./docs/tools/browser-tools-mcp.md)** | ⚠️ `AS-002`, `AS-011`, `AS-007` ×5 | Mar 16 |
| [ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) | `1.4.0` | 6.4k | **[A](./docs/tools/ida-pro-mcp.md)** | `AS-007` ×6 | Mar 16 |
...
| [enscan-go](https://github.com/wgpsec/ENScan_GO) | `2.0.4` | 4.2k | **[A](./docs/tools/enscan-go.md)** | `AS-007` ×2 | Mar 16 |
| [kubefwd](https://github.com/txn2/kubefwd) | `1.25.12` | 4.1k | **[C](./docs/tools/kubefwd.md)** | ⚠️ `AS-002` ×4, `AS-003`, `AS-011` | Mar 16 |
