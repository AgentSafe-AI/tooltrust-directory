...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1829-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--08--12-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1829 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 198.0M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Aug 12 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.79` | 25.9M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Aug 12 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 11.2M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Aug 12 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 7.5M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Aug 12 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.9M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Aug 12 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 1.9M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Aug 12 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.56.0-pre…` | 1.9M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Aug 12 |
...
| [editor](https://github.com/pascalorg/editor) | `1.0.0-beta.1` | 1.6M/mo | **[A](./docs/tools/editor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×5 | Aug 12 |
| [inspector](https://github.com/modelcontextprotocol/inspector) | `2-alpha-15` | 905.4k/mo | **[A](./docs/tools/inspector.md)** | `AS-014` ×2 | Aug 12 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 739.6k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Aug 12 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.69.0` | 601.3k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Aug 12 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 571.6k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Aug 12 |
| [azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp) | `2.9.0` | 540.4k/mo | **[A](./docs/tools/azure-devops-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 12 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 536.4k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Aug 12 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 511.2k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Aug 12 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 412.5k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Aug 12 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 350.3k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 12 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.47` | 313.7k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Aug 12 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `0.21.11-pr…` | 313.1k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×23, 🔑 `AS-002`, ⚡ `AS-011` | Aug 12 |
...
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 233.1k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Aug 12 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 142.9k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Aug 12 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 142.7k/mo | **[C](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Aug 12 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.22` | 140.9k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Aug 12 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.141.0` | 133.3k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Aug 12 |
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 128.5k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Aug 12 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 112.7k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 12 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.0` | 104.6k/mo | **[B](./docs/tools/brave-search-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 12 |
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.39.1` | 96.6k/mo | **[A](./docs/tools/figma-console-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 12 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.2` | 95.4k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×5, `AS-014` ×27 | Aug 12 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 89.5k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Aug 12 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.0` | 87.5k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 12 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.14.2` | 83.3k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Aug 12 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 83.2k/mo | **[C](./docs/tools/mcp-playwright.md)** | `AS-012`, 🔑 `AS-002` ×6, `AS-014` ×6, ⚡ `AS-011` ×5, ⚡ `AS-006` | Aug 12 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.5.23` | 80.8k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×39, `AS-014` ×39, ⚡ `AS-011` ×5 | Aug 12 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.4` | 79.9k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Aug 12 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 78.6k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Aug 12 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 73.4k/mo | **[B](./docs/tools/context-mode.md)** | `AS-012`, 🔑 `AS-002` ×7, `AS-014` ×7, ⚡ `AS-011` | Aug 12 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.38.0` | 73.2k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Aug 12 |
| [neo](https://github.com/neomjs/neo) | `11.19.1` | 71.9k/mo | **[A](./docs/tools/neo.md)** | `AS-014` ×8 | Aug 12 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 70.7k | **[A](./docs/tools/agent-reach.md)** | `AS-014` ×13, 🔑 `AS-002` ×4, 🗝️ `AS-010` ×12, ⚡ `AS-011` ×2 | Aug 12 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.15.0` | 70.0k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×3, `AS-014` ×4 | Aug 12 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.34.0` | 66.0k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 12 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.7.0` | 58.3k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 12 |
