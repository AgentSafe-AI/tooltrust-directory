...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-526-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--04--10-blue)](./data/reports/)
...
*Top 50 by popularity. View all 526 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.39.0-nig…` | 3.1M/mo | **[C](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×35, ⚡ `AS-011` ×11 | Apr 10 |
| [upstash-context7-mcp](https://github.com/upstash/context7) | `1.0.30` | 3.0M/mo | **[B](./docs/tools/upstash-context7-mcp.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Apr 10 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.0M/mo | **[B](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Apr 10 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 2.6M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×3 | Apr 10 |
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.0M/mo | **[C](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×15, ⚡ `AS-011` | Apr 10 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 479.2k/mo | **[C](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×35, ⚡ `AS-011` ×18 | Apr 10 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.47.6` | 439.0k/mo | **[C](./docs/tools/n8n-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×2 | Apr 10 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 420.1k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | ✅ None | Apr 10 |
...
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.18` | 328.7k/mo | **[C](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×5 | Apr 10 |
...
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.1.0` | 256.4k/mo | **[C](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×22 | Apr 10 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 121.1k/mo | **[C](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×14, ⚡ `AS-011` ×6, `AS-014` ×6 | Apr 10 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 112.6k/mo | **[B](./docs/tools/claude-task-master.md)** | `AS-014` ×14, 🔑 `AS-002` ×9, ⚡ `AS-011` | Apr 10 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 83.3k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Apr 10 |
| [mcp-server-fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) | `typescript…` | 83.3k | **[B](./docs/tools/mcp-server-fetch.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×3 | Apr 10 |
...
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.31-beta` | 66.2k/mo | **[B](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` | Apr 10 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.38` | 63.9k/mo | **[C](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×22, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Apr 10 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.5.78` | 59.5k/mo | **[B](./docs/tools/ruflo.md)** | `AS-014` ×19, 🔑 `AS-002` ×3, ⚡ `AS-011` | Apr 10 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.0` | 58.1k/mo | **[C](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×3, `AS-014` ×3 | Apr 10 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.73.1` | 57.8k/mo | **[C](./docs/tools/ms-365-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×238, ⚡ `AS-011` ×111 | Apr 10 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.9.17` | 51.8k/mo | **[D](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×27, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Apr 10 |
| [mcp-server-serper](https://github.com/marcopesani/mcp-server-serper) | `0.2.0` | 50.5k/mo | **[C](./docs/tools/mcp-server-serper.md)** | 🔑 `AS-002` ×14, ⚡ `AS-011` ×6, `AS-014` ×6 | Apr 10 |
...
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.75` | 49.3k/mo | **[D](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×16, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Apr 10 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 48.6k/mo | **[B](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Apr 10 |
| [aas-ee-open-websearch](https://github.com/Aas-ee/open-webSearch) | `2.1.6` | 43.9k/mo | **[C](./docs/tools/aas-ee-open-websearch.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×6 | Apr 10 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `3.5.0` | 42.6k/mo | **[B](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Apr 10 |
| [dive](https://github.com/OpenAgentPlatform/Dive) | `0.14.2` | 34.5k/mo | **[A](./docs/tools/dive.md)** | `AS-014` ×2 | Apr 10 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.0.75` | 31.0k/mo | **[C](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×14, ⚡ `AS-011` ×6, `AS-014` ×6 | Apr 10 |
| [railway-mcp-server](https://github.com/railwayapp/railway-mcp-server) | `0.1.8` | 29.1k/mo | **[C](./docs/tools/railway-mcp-server.md)** | 🔑 `AS-002` ×20, ⚡ `AS-011` | Apr 10 |
| [github-mcp-server](https://github.com/github/github-mcp-server) | `0.33.0` | 28.7k | **[C](./docs/tools/github-mcp-server.md)** | 🔑 `AS-002` ×75, ⚡ `AS-011` ×36, `AS-014` ×86, 📐 `AS-003`, 🗝️ `AS-010` | Apr 10 |
| [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | `2.9.4` | 20.2k/mo | **[C](./docs/tools/brightdata-mcp.md)** | 🔑 `AS-002` ×67, ⚡ `AS-011` ×58, `AS-014` ×65 | Apr 10 |
| [mcp-server](https://github.com/mapbox/mcp-server) | `99.0.0-dev` | 18.4k/mo | **[C](./docs/tools/mcp-server.md)** | 🔑 `AS-002` ×15, ⚡ `AS-011` ×6 | Apr 10 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 16.0k/mo | **[D](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Apr 10 |
| [mcp-server-asana](https://github.com/roychri/mcp-server-asana) | `1.6.0` | 14.8k/mo | **[C](./docs/tools/mcp-server-asana.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×3, `AS-014` ×10 | Apr 10 |
| [git-mcp-server](https://github.com/cyanheads/git-mcp-server) | `2.10.5` | 14.7k/mo | **[C](./docs/tools/git-mcp-server.md)** | 🔑 `AS-002` ×38, ⚡ `AS-011` ×8 | Apr 10 |
| [mcp-server-trello](https://github.com/delorenj/mcp-server-trello) | `1.6.1` | 13.8k/mo | **[C](./docs/tools/mcp-server-trello.md)** | 🔑 `AS-002` ×126, `AS-014` ×200, ⚡ `AS-011` ×53, 🗝️ `AS-010` | Apr 10 |
| [postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server) | `2.8.4` | 13.1k/mo | **[C](./docs/tools/postman-mcp-server.md)** | 🔑 `AS-002` ×53, ⚡ `AS-011` ×15, `AS-014` ×41 | Apr 10 |
| [line-bot-mcp-server](https://github.com/line/line-bot-mcp-server) | `0.4.2` | 12.2k/mo | **[A](./docs/tools/line-bot-mcp-server.md)** | 🔑 `AS-002` ×4, `AS-014` ×10 | Apr 10 |
...
| [mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server) | `1.0.3` | 12.0k/mo | **[C](./docs/tools/mcp-bigquery-server.md)** | 🔑 `AS-002` ×8, `AS-014` ×5, ⚡ `AS-011` | Apr 10 |
| [mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) | `3.0.0` | 11.7k/mo | **[B](./docs/tools/mcp-server-browserbase.md)** | `AS-014` ×6, 🔑 `AS-002`, ⚡ `AS-011` | Apr 10 |
| [airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) | `1.13.0` | 11.0k/mo | **[B](./docs/tools/airtable-mcp-server.md)** | `AS-014` ×13, 🔑 `AS-002` ×8, ⚡ `AS-011` | Apr 10 |
...
| [openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server) | `1.2.0-beta04` | 10.0k/mo | **[C](./docs/tools/openapi-mcp-server.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×2 | Apr 10 |
| [openmetadata](https://github.com/open-metadata/OpenMetadata) | `1.2.1` | 9.9k | **[B](./docs/tools/openmetadata.md)** | `AS-012`, `AS-014` ×10, 🔑 `AS-002` ×4, ⚡ `AS-011` ×4 | Apr 10 |
| [figma-mcp-server](https://github.com/TimHolden/figma-mcp-server) | `1.0.0` | 9.8k/mo | **[C](./docs/tools/figma-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×58, `AS-014` ×49, ⚡ `AS-011` ×15, 🗝️ `AS-010` ×2 | Apr 10 |
