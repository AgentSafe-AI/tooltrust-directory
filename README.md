...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1885-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--09--26-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1885 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 195.8M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Sep 26 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.82` | 24.1M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×25, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Sep 26 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `2.0.3` | 14.0M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Sep 26 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 8.2M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×30, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Sep 26 |
...
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.3M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Sep 26 |
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.9M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Sep 26 |
...
| [editor](https://github.com/pascalorg/editor) | `1.0.3` | 1.4M/mo | **[A](./docs/tools/editor.md)** | `AS-014` ×49, 🔑 `AS-002` ×13, ⚡ `AS-011` | Sep 26 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.63.0-nig…` | 1.3M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Sep 26 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.2` | 629.0k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Sep 26 |
| [agent-device](https://github.com/callstack/agent-device) | `w4-find-wi…` | 583.6k/mo | **[A](./docs/tools/agent-device.md)** | `AS-014` | Sep 26 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 481.6k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Sep 26 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.89.0` | 469.3k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Sep 26 |
...
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.51` | 430.7k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Sep 26 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 404.9k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Sep 26 |
...
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 284.8k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Sep 26 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `weaken-too…` | 250.8k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×30, 🔑 `AS-002` ×2, ⚡ `AS-011` ×2 | Sep 26 |
...
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.1` | 241.6k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 26 |
| [mcp-framework](https://github.com/QuantGeekDev/mcp-framework) | `mcp-framew…` | 208.2k/mo | **[B](./docs/tools/mcp-framework.md)** | 🔑 `AS-002` ×9, ⚡ `AS-011` ×9, `AS-014` ×10, 📐 `AS-003` ×2 | Sep 26 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.24.1` | 184.2k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×32, `AS-014` ×27, ⚡ `AS-011` ×25, 🗝️ `AS-010` | Sep 26 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.156.2` | 148.2k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182, 🗝️ `AS-010` ×48 | Sep 26 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 121.3k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Sep 26 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.5` | 119.3k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×6, `AS-014` ×32 | Sep 26 |
| [magic-mcp](https://github.com/21st-dev/magic-mcp) | `0.2.3` | 105.4k/mo | **[A](./docs/tools/magic-mcp.md)** | `AS-014` ×43, 🔑 `AS-002` ×42, ⚡ `AS-011` ×36, ⚡ `AS-006` | Sep 26 |
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 101.0k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Sep 26 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 90.6k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Sep 26 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.16.0` | 88.0k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 26 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.10.0` | 87.4k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 26 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 85.5k | **[A](./docs/tools/agent-reach.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×4, `AS-014` ×9 | Sep 26 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.23` | 75.5k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Sep 26 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.39.0` | 73.8k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 26 |
| [davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) | `4.8.20` | 72.1k/mo | **[A](./docs/tools/davinci-resolve-mcp.md)** | `AS-014` | Sep 26 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 71.0k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 26 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 70.1k/mo | **[C](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×10, ⚡ `AS-006` ×3, `AS-014` ×11, ⚡ `AS-011` ×6 | Sep 26 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.45.0` | 70.0k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Sep 26 |
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.40.6` | 63.1k/mo | **[C](./docs/tools/figma-console-mcp.md)** | `AS-014` ×121, 🔑 `AS-002` ×78, ⚡ `AS-011` ×41, ⚡ `AS-006`, 🗝️ `AS-010` | Sep 26 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.10.0` | 59.3k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Sep 26 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.4` | 57.8k/mo | **[A](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 26 |
| [ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | `2026.09` | 57.6k | **[A](./docs/tools/ai-engineering-from-scratch.md)** | `AS-014` ×5, 🔑 `AS-002`, ⚡ `AS-011` | Sep 26 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 52.5k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Sep 26 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 51.3k/mo | **[C](./docs/tools/mcp-playwright.md)** | `AS-012`, 🔑 `AS-002` ×6, `AS-014` ×6, ⚡ `AS-011` ×5, ⚡ `AS-006` | Sep 26 |
| [ai-agent-book](https://github.com/bojieli/ai-agent-book) | `1.2` | 51.0k | **[C](./docs/tools/ai-agent-book.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 26 |
