...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1762-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--07--26-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1762 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.78` | 26.2M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Jul 26 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 9.8M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Jul 26 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 8.8M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Jul 26 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.5M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Jul 26 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.2M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Jul 26 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.54.0-nig…` | 2.0M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Jul 26 |
...
| [inspector](https://github.com/modelcontextprotocol/inspector) | `2-alpha-15` | 816.4k/mo | **[A](./docs/tools/inspector.md)** | `AS-014` ×2 | Jul 26 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 674.1k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Jul 26 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 614.3k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Jul 26 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 565.2k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Jul 26 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.66.0` | 480.7k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Jul 26 |
...
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 424.1k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Jul 26 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 397.7k/mo | **[C](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×32, ⚡ `AS-011` ×25, `AS-014` ×26, ⚡ `AS-006` | Jul 26 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.46` | 350.1k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Jul 26 |
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 200.4k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Jul 26 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.19.0` | 142.3k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×11, `AS-014` ×13, 📐 `AS-003` ×2 | Jul 26 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.21` | 133.4k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Jul 26 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.133.1` | 107.5k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Jul 26 |
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.38.0` | 102.0k/mo | **[A](./docs/tools/figma-console-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Jul 26 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 99.0k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Jul 26 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 95.6k/mo | **[A](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Jul 26 |
| [mcp-server-trello](https://github.com/delorenj/mcp-server-trello) | `1.8.1` | 95.1k/mo | **[A](./docs/tools/mcp-server-trello.md)** | 🔑 `AS-002` ×106, `AS-014` ×200, ⚡ `AS-011` ×53, 🗝️ `AS-010` | Jul 26 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 94.8k/mo | **[A](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×7, `AS-014` ×7, ⚡ `AS-011` | Jul 26 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 88.9k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Jul 26 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.32.9` | 81.3k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Jul 26 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.62` | 80.3k/mo | **[A](./docs/tools/mobile-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×5, ⚡ `AS-011` | Jul 26 |
...
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.5.23` | 74.2k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×39, `AS-014` ×39, ⚡ `AS-011` ×5 | Jul 26 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.1` | 71.1k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Jul 26 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 69.1k/mo | **[C](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Jul 26 |
...
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 66.7k/mo | **[A](./docs/tools/claude-task-master.md)** | `AS-014` ×14, 🔑 `AS-002` ×9, ⚡ `AS-011` | Jul 26 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.12.0` | 63.9k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Jul 26 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.0.9` | 63.9k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Jul 26 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.32.0` | 62.4k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Jul 26 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 60.8k | **[B](./docs/tools/agent-reach.md)** | `AS-012`, `AS-014` ×4, 🔑 `AS-002` ×3, ⚡ `AS-011` ×2 | Jul 26 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.12.0` | 59.7k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Jul 26 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.6.0` | 57.7k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Jul 26 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 49.5k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Jul 26 |
...
| [browsermcp](https://github.com/browsermcp/mcp) | `0.1.3` | 45.3k/mo | **[A](./docs/tools/browsermcp.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×12 | Jul 26 |
| [kong](https://github.com/Kong/kong) | `3.9.3` | 43.9k | **[A](./docs/tools/kong.md)** | `AS-014` | Jul 26 |
| [codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | `0.9.0` | 35.3k | **[B](./docs/tools/codebase-memory-mcp.md)** | `AS-012`, 🔑 `AS-002`, `AS-014` | Jul 26 |
