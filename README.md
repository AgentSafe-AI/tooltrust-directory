...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1880-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--09--16-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1880 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 199.4M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Sep 16 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.81` | 23.4M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×26, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Sep 16 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `2.0.0` | 13.4M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Sep 16 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 9.3M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Sep 16 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.7M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Sep 16 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.9M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Sep 16 |
...
| [editor](https://github.com/pascalorg/editor) | `1.0.0` | 1.5M/mo | **[A](./docs/tools/editor.md)** | `AS-014` ×46, 🔑 `AS-002` ×12, ⚡ `AS-011` | Sep 16 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.62.0-nig…` | 1.4M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Sep 16 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 627.9k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Sep 16 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.85.0` | 531.8k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Sep 16 |
| [agent-device](https://github.com/callstack/agent-device) | `w4-find-wi…` | 530.7k/mo | **[A](./docs/tools/agent-device.md)** | `AS-014` | Sep 16 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 530.1k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Sep 16 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 485.1k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Sep 16 |
...
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 429.0k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Sep 16 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 307.5k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Sep 16 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.50` | 278.3k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Sep 16 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `weaken-too…` | 275.0k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×28, 🔑 `AS-002`, ⚡ `AS-011` | Sep 16 |
...
| [mcp-framework](https://github.com/QuantGeekDev/mcp-framework) | `mcp-framew…` | 225.8k/mo | **[B](./docs/tools/mcp-framework.md)** | `AS-012`, 🔑 `AS-002` ×9, ⚡ `AS-011` ×9, `AS-014` ×10, 📐 `AS-003` ×2 | Sep 16 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.24.1` | 178.2k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Sep 16 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.1` | 165.0k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 16 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.154.0` | 160.3k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182, 🗝️ `AS-010` ×48 | Sep 16 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.15.7` | 133.0k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 16 |
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 126.6k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Sep 16 |
...
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 124.1k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Sep 16 |
...
| [magic-mcp](https://github.com/21st-dev/magic-mcp) | `0.2.3` | 111.8k/mo | **[A](./docs/tools/magic-mcp.md)** | `AS-014` ×43, 🔑 `AS-002` ×42, ⚡ `AS-011` ×36, ⚡ `AS-006` | Sep 16 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 90.4k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Sep 16 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.22` | 86.8k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Sep 16 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.10.0` | 86.5k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 16 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 82.1k | **[A](./docs/tools/agent-reach.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×4, `AS-014` ×9 | Sep 16 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.42.0` | 77.2k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Sep 16 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 76.1k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 16 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.4` | 73.4k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×6, `AS-014` ×32 | Sep 16 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 72.5k/mo | **[C](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×10, ⚡ `AS-006` ×3, `AS-014` ×11, ⚡ `AS-011` ×6 | Sep 16 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.37.0` | 72.3k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 16 |
| [mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript) | `3.1.1` | 69.4k/mo | **[A](./docs/tools/mcp-server-typescript.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Sep 16 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 63.2k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Sep 16 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.3` | 63.0k/mo | **[A](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 16 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 59.8k/mo | **[C](./docs/tools/mcp-playwright.md)** | `AS-012`, `AS-014` ×33, 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×9, 🗝️ `AS-010` ×5 | Sep 16 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.10.0` | 59.1k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Sep 16 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `2.3.0` | 57.8k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×3, `AS-014` ×4 | Sep 16 |
| [davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) | `4.7.3` | 56.3k/mo | **[A](./docs/tools/davinci-resolve-mcp.md)** | `AS-014` | Sep 16 |
| [ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | `2026.09` | 54.7k | **[A](./docs/tools/ai-engineering-from-scratch.md)** | `AS-014` ×5, 🔑 `AS-002`, ⚡ `AS-011` | Sep 16 |
