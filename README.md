...
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.18` | 307.6k/mo | **[C](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×5 | Apr 3 |
...
| [mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) | `3.0.0` | 11.1k/mo | **[B](./docs/tools/mcp-server-browserbase.md)** | `AS-014` ×6, 🔑 `AS-002`, ⚡ `AS-011` | Apr 3 |
...
| [mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket) | `3.1.0` | 9.4k/mo | **[C](./docs/tools/mcp-server-atlassian-bitbucket.md)** | 🔑 `AS-002` ×18, ⚡ `AS-011` ×6 | Apr 3 |
