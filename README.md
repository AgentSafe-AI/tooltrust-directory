...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1886-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--09--22-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1886 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 189.9M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Sep 22 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.82` | 22.6M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×25, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Sep 22 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `2.0.0` | 13.2M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Sep 22 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 7.8M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Sep 22 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.5M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Sep 22 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.9M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Sep 22 |
...
| [editor](https://github.com/pascalorg/editor) | `1.0.0` | 1.4M/mo | **[A](./docs/tools/editor.md)** | `AS-014` ×46, 🔑 `AS-002` ×12, ⚡ `AS-011` | Sep 22 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.62.0-nig…` | 1.3M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Sep 22 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.2` | 595.3k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Sep 22 |
| [agent-device](https://github.com/callstack/agent-device) | `w4-find-wi…` | 508.7k/mo | **[B](./docs/tools/agent-device.md)** | `AS-012`, `AS-014` | Sep 22 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 478.0k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Sep 22 |
...
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.87.0` | 442.7k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Sep 22 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 404.8k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Sep 22 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 388.3k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Sep 22 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.51` | 385.4k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Sep 22 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 278.6k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Sep 22 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `weaken-too…` | 257.5k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×28, 🔑 `AS-002`, ⚡ `AS-011` | Sep 22 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.1` | 250.1k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 22 |
...
| [mcp-framework](https://github.com/QuantGeekDev/mcp-framework) | `mcp-framew…` | 217.9k/mo | **[B](./docs/tools/mcp-framework.md)** | 🔑 `AS-002` ×9, ⚡ `AS-011` ×9, `AS-014` ×10, 📐 `AS-003` ×2 | Sep 22 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.154.3` | 152.3k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182, 🗝️ `AS-010` ×48 | Sep 22 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.24.1` | 127.2k/mo | **[B](./docs/tools/firecrawl-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×32, `AS-014` ×27, ⚡ `AS-011` ×25, 🗝️ `AS-010` | Sep 22 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 114.4k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Sep 22 |
| [magic-mcp](https://github.com/21st-dev/magic-mcp) | `0.2.3` | 109.3k/mo | **[A](./docs/tools/magic-mcp.md)** | `AS-014` ×43, 🔑 `AS-002` ×42, ⚡ `AS-011` ×36, ⚡ `AS-006` | Sep 22 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.16.0` | 107.9k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 22 |
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 106.5k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Sep 22 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.4` | 97.1k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×6, `AS-014` ×32 | Sep 22 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 90.5k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Sep 22 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.10.0` | 87.2k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 22 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 84.4k | **[A](./docs/tools/agent-reach.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×4, `AS-014` ×9 | Sep 22 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.23` | 75.3k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Sep 22 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.38.0` | 73.4k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 22 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.42.5` | 71.7k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Sep 22 |
| [davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) | `4.8.15` | 71.7k/mo | **[A](./docs/tools/davinci-resolve-mcp.md)** | `AS-014` | Sep 22 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 69.9k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 22 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 67.9k/mo | **[C](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×10, ⚡ `AS-006` ×3, `AS-014` ×11, ⚡ `AS-011` ×6 | Sep 22 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.10.0` | 59.2k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Sep 22 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.4` | 57.7k/mo | **[A](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 22 |
| [ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | `2026.09` | 55.2k | **[A](./docs/tools/ai-engineering-from-scratch.md)** | `AS-014` ×5, 🔑 `AS-002`, ⚡ `AS-011` | Sep 22 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 54.7k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Sep 22 |
| [mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript) | `3.1.1` | 54.3k/mo | **[A](./docs/tools/mcp-server-typescript.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Sep 22 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 53.4k/mo | **[C](./docs/tools/mcp-playwright.md)** | `AS-014` ×33, 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×9, 🗝️ `AS-010` ×5 | Sep 22 |
| [ai-agent-book](https://github.com/bojieli/ai-agent-book) | `1.2` | 49.8k | **[C](./docs/tools/ai-agent-book.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 22 |
