...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1816-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--08--04-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1816 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 182.0M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Aug 4 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.78` | 25.7M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Aug 4 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 9.7M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Aug 4 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 8.3M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Aug 4 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.0M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Aug 4 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.2M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Aug 4 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.55.0-nig…` | 1.9M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Aug 4 |
...
| [inspector](https://github.com/modelcontextprotocol/inspector) | `2-alpha-15` | 857.9k/mo | **[A](./docs/tools/inspector.md)** | `AS-014` ×2 | Aug 4 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 713.4k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Aug 4 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 705.6k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Aug 4 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.67.3` | 576.8k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Aug 4 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 541.5k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Aug 4 |
| [azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp) | `2.9.0` | 526.3k/mo | **[A](./docs/tools/azure-devops-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 4 |
...
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 423.8k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Aug 4 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 323.4k/mo | **[B](./docs/tools/firecrawl-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Aug 4 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `0.21.4` | 308.3k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×54 | Aug 4 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 307.6k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 4 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.46` | 298.2k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Aug 4 |
| [mcp-framework](https://github.com/QuantGeekDev/mcp-framework) | `mcp-framew…` | 239.4k/mo | **[A](./docs/tools/mcp-framework.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 4 |
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 213.9k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Aug 4 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.136.0` | 140.3k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Aug 4 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 138.8k/mo | **[C](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Aug 4 |
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.19.1` | 130.8k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×11, `AS-014` ×13, 📐 `AS-003` ×2 | Aug 4 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.21` | 127.1k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Aug 4 |
...
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 125.3k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Aug 4 |
| [mcp-server-trello](https://github.com/delorenj/mcp-server-trello) | `1.8.1` | 122.1k/mo | **[A](./docs/tools/mcp-server-trello.md)** | 🔑 `AS-002` ×106, `AS-014` ×200, ⚡ `AS-011` ×53, 🗝️ `AS-010` | Aug 4 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 107.4k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 4 |
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.39.1` | 104.7k/mo | **[A](./docs/tools/figma-console-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 4 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.0` | 95.9k/mo | **[A](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 4 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 89.2k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Aug 4 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.34.0` | 85.3k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Aug 4 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 83.0k/mo | **[A](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Aug 4 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 82.2k/mo | **[C](./docs/tools/mcp-playwright.md)** | 🔑 `AS-002` ×6, `AS-014` ×6, ⚡ `AS-011` ×5, ⚡ `AS-006` | Aug 4 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.2` | 78.8k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Aug 4 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.5.23` | 78.5k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×39, `AS-014` ×39, ⚡ `AS-011` ×5 | Aug 4 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.0` | 74.7k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 4 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.0` | 74.2k/mo | **[A](./docs/tools/mobile-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×5, ⚡ `AS-011` | Aug 4 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 72.8k/mo | **[B](./docs/tools/context-mode.md)** | `AS-012`, 🔑 `AS-002` ×4, `AS-014` ×8, ⚡ `AS-011` | Aug 4 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.14.1` | 72.8k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Aug 4 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 70.5k/mo | **[A](./docs/tools/claude-task-master.md)** | `AS-014` ×14, 🔑 `AS-002` ×9, ⚡ `AS-011` | Aug 4 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 65.8k | **[A](./docs/tools/agent-reach.md)** | `AS-014` ×4, 🔑 `AS-002` ×3, ⚡ `AS-011` ×2 | Aug 4 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.14.0` | 64.7k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Aug 4 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.33.0` | 64.4k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 4 |
| [neo](https://github.com/neomjs/neo) | `11.19.1` | 59.9k/mo | **[A](./docs/tools/neo.md)** | `AS-014` ×8 | Aug 4 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.6.0` | 58.0k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 4 |
