...
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--09--04-blue)](./data/reports/)
...
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 204.0M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Sep 4 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.80` | 24.4M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-012`, 🔑 `AS-002` ×6, `AS-014` ×6, ⚡ `AS-011` ×5, ⚡ `AS-006` | Sep 4 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 12.8M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Sep 4 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 10.0M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Sep 3 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.0M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Sep 4 |
...
| [editor](https://github.com/pascalorg/editor) | `1.0.0-beta.1` | 1.7M/mo | **[A](./docs/tools/editor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×5 | Sep 4 |
...
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.60.0-nig…` | 1.6M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Sep 4 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 713.0k/mo | **[B](./docs/tools/notion-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×15, ⚡ `AS-011` ×11, `AS-014` ×14 | Sep 4 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 654.2k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Sep 4 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.82.1` | 580.7k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Sep 4 |
| [agent-device](https://github.com/callstack/agent-device) | `0.20.10` | 545.2k/mo | **[A](./docs/tools/agent-device.md)** | `AS-014` | Sep 4 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 494.7k/mo | **[B](./docs/tools/mcp-server-github.md)** | `AS-012`, 🔑 `AS-002` ×52, ⚡ `AS-011` ×36, `AS-014` ×86, 📐 `AS-003`, 🗝️ `AS-010` | Sep 4 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 484.4k/mo | **[B](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-012`, 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` | Sep 4 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.24.1` | 455.7k/mo | **[B](./docs/tools/firecrawl-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×10, `AS-014` ×8, ⚡ `AS-011` ×7 | Sep 4 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 335.7k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Sep 4 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `weaken-too…` | 296.3k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×28, 🔑 `AS-002`, ⚡ `AS-011` | Sep 4 |
...
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.48` | 231.3k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Sep 4 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.149.1` | 169.8k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | 🔑 `AS-002` ×18, `AS-014` ×24, ⚡ `AS-011` ×14 | Sep 4 |
| [magic-mcp](https://github.com/21st-dev/magic-mcp) | `0.2.2` | 155.8k/mo | **[A](./docs/tools/magic-mcp.md)** | `AS-014` ×43, 🔑 `AS-002` ×42, ⚡ `AS-011` ×36, ⚡ `AS-006` | Sep 4 |
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 144.0k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | `AS-012`, `AS-014` ×22, 🔑 `AS-002` ×14, ⚡ `AS-011` ×12, 📐 `AS-003` ×2 | Sep 4 |
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 132.1k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Sep 4 |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.15.4` | 121.7k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 4 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.1` | 120.2k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 4 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.22` | 117.7k/mo | **[B](./docs/tools/tavily-mcp.md)** | `AS-012`, 🔑 `AS-002` ×8, ⚡ `AS-011` ×5, `AS-014` ×6, 🗝️ `AS-010` | Sep 4 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.2` | 97.3k/mo | **[B](./docs/tools/mobile-mcp.md)** | `AS-012`, `AS-014` ×25, 🔑 `AS-002` ×7, ⚡ `AS-011` ×6 | Sep 4 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 92.9k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 4 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `2.1.0` | 92.1k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×3, `AS-014` ×4 | Sep 3 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 90.1k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Sep 4 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.3` | 87.8k/mo | **[A](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 4 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.10.0` | 85.5k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 4 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 80.0k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Sep 4 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 78.5k/mo | **[C](./docs/tools/mcp-playwright.md)** | 🔑 `AS-002` ×6, `AS-014` ×6, ⚡ `AS-011` ×5, ⚡ `AS-006` | Sep 4 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 77.8k | **[A](./docs/tools/agent-reach.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×5, 🗝️ `AS-010` | Sep 4 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.38.21` | 75.4k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Sep 4 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.37.0` | 68.8k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 4 |
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.40.0` | 62.5k/mo | **[B](./docs/tools/figma-console-mcp.md)** | `AS-012`, `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Sep 4 |
| [mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript) | `3.1.1` | 60.2k/mo | **[B](./docs/tools/mcp-server-typescript.md)** | `AS-012`, 🔑 `AS-002` ×4, ⚡ `AS-011` ×4, `AS-014` ×4 | Sep 4 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.9.0` | 58.8k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Sep 4 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 56.4k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Sep 4 |
| [ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | `2026.08` | 52.3k | **[A](./docs/tools/ai-engineering-from-scratch.md)** | `AS-014` ×5, 🔑 `AS-002`, ⚡ `AS-011` | Sep 4 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.6` | 51.6k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Sep 4 |
