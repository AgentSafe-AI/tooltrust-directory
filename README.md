...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1845-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--09--13-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1845 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 199.4M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Sep 13 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.80` | 23.4M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Sep 13 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `2.0.0` | 13.4M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Sep 13 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 9.3M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Sep 13 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.7M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Sep 13 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.9M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Sep 13 |
...
| [editor](https://github.com/pascalorg/editor) | `1.0.0` | 1.5M/mo | **[A](./docs/tools/editor.md)** | `AS-014` ×46, 🔑 `AS-002` ×12, ⚡ `AS-011` | Sep 13 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.61.0-nig…` | 1.4M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Sep 13 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 627.9k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Sep 13 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.84.4` | 531.8k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Sep 13 |
| [agent-device](https://github.com/callstack/agent-device) | `w4-find-wi…` | 526.2k/mo | **[A](./docs/tools/agent-device.md)** | `AS-014` | Sep 12 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 485.1k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Sep 13 |
...
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 429.0k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Sep 13 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.50` | 278.3k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Sep 13 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `weaken-too…` | 275.0k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×28, 🔑 `AS-002`, ⚡ `AS-011` | Sep 13 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.24.1` | 178.2k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Sep 13 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.1` | 165.0k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 13 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.154.0` | 160.3k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182, 🗝️ `AS-010` ×48 | Sep 13 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.15.7` | 133.0k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 13 |
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 126.6k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Sep 13 |
...
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 90.3k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Sep 13 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.22` | 86.8k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Sep 13 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.10.0` | 86.1k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 13 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 79.8k | **[A](./docs/tools/agent-reach.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×4, `AS-014` ×9 | Sep 13 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.41.2` | 77.2k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Sep 13 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 76.1k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Sep 13 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.3` | 73.4k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×6, `AS-014` ×32 | Sep 13 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 72.5k/mo | **[C](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×10, ⚡ `AS-006` ×3, `AS-014` ×11, ⚡ `AS-011` ×6 | Sep 13 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.37.0` | 71.8k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Sep 13 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 63.2k/mo | **[A](./docs/tools/claude-task-master.md)** | 🔑 `AS-002` ×23, `AS-014` ×57, ⚡ `AS-011` ×8, 🗝️ `AS-010` | Sep 13 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.3` | 63.0k/mo | **[B](./docs/tools/brave-search-mcp-server.md)** | `AS-012`, 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` | Sep 13 |
...
| [mempalace](https://github.com/MemPalace/mempalace) | `3.9.0` | 59.0k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Sep 13 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `2.2.0` | 57.8k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×3, `AS-014` ×4 | Sep 13 |
| [davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) | `3.2.0` | 56.3k/mo | **[A](./docs/tools/davinci-resolve-mcp.md)** | `AS-014` | Sep 13 |
| [ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) | `2026.09` | 54.4k | **[A](./docs/tools/ai-engineering-from-scratch.md)** | `AS-014` ×5, 🔑 `AS-002`, ⚡ `AS-011` | Sep 13 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 51.4k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Sep 12 |
| [ai-agent-book](https://github.com/bojieli/ai-agent-book) | `1.2` | 46.1k | **[C](./docs/tools/ai-agent-book.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Sep 13 |
| [kong](https://github.com/Kong/kong) | `3.9.3` | 44.1k | **[A](./docs/tools/kong.md)** | `AS-014` | Sep 13 |
