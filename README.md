...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1103-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--05--18-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1103 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.75` | 9.3M/mo | **[D](./docs/tools/playwright-mcp.md)** | 🔑 `AS-002` ×15, ⚡ `AS-006` ×2, ⚡ `AS-011` ×6 | May 18 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 6.8M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×3 | May 18 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.9M/mo | **[B](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | May 18 |
| [upstash-context7-mcp](https://github.com/upstash/context7) | `1.0.30` | 4.9M/mo | **[B](./docs/tools/upstash-context7-mcp.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | May 18 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.44.0-nig…` | 3.5M/mo | **[C](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×35, ⚡ `AS-011` ×11 | May 18 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 1.3M/mo | **[C](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×15, ⚡ `AS-011` | May 18 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 519.8k/mo | **[C](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×35, ⚡ `AS-011` ×18 | May 18 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.53.0` | 479.4k/mo | **[C](./docs/tools/n8n-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×2 | May 18 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 425.8k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | ✅ None | May 18 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.5.2` | 314.4k/mo | **[B](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×35, ⚡ `AS-011` ×3 | May 18 |
...
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.19` | 292.6k/mo | **[C](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×5 | May 18 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.11.0` | 268.1k/mo | **[B](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | May 18 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.1.0` | 261.9k/mo | **[C](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×22 | May 18 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 224.3k/mo | **[C](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×14, `AS-014` ×8, ⚡ `AS-011` ×7 | May 18 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 106.4k/mo | **[C](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | May 18 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.108.0` | 103.7k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×21 | May 18 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.136` | 86.8k/mo | **[C](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×9, `AS-014` ×7, ⚡ `AS-011` | May 18 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 85.8k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | May 18 |
| [mcp-server-fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) | `typescript…` | 85.8k | **[B](./docs/tools/mcp-server-fetch.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×5 | May 18 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.41` | 78.9k/mo | **[C](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×22, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | May 18 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.7.0-alph…` | 78.2k/mo | **[B](./docs/tools/ruflo.md)** | `AS-014` ×33, 🔑 `AS-002` ×25, ⚡ `AS-011` | May 18 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.0.82` | 69.8k/mo | **[C](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | May 18 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 68.0k/mo | **[B](./docs/tools/claude-task-master.md)** | `AS-014` ×14, 🔑 `AS-002` ×9, ⚡ `AS-011` | May 18 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.1` | 67.1k/mo | **[C](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` ×2 | May 18 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.10.4` | 62.3k/mo | **[D](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×27, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | May 18 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `3.6.2` | 59.8k/mo | **[B](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | May 18 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.31-beta` | 57.2k/mo | **[B](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` | May 18 |
| [git-mcp-server](https://github.com/cyanheads/git-mcp-server) | `2.15.1` | 42.6k/mo | **[C](./docs/tools/git-mcp-server.md)** | 🔑 `AS-002` ×39, ⚡ `AS-011` ×9 | May 18 |
| [aas-ee-open-websearch](https://github.com/Aas-ee/open-webSearch) | `2.1.11` | 39.0k/mo | **[C](./docs/tools/aas-ee-open-websearch.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×6 | May 18 |
| [dive](https://github.com/OpenAgentPlatform/Dive) | `0.14.2` | 33.4k/mo | **[C](./docs/tools/dive.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×2, `AS-014` ×2 | May 18 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 33.1k/mo | **[B](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | May 18 |
| [antvis-mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 33.1k/mo | **[B](./docs/tools/antvis-mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | May 18 |
| [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | `2.9.5` | 32.1k/mo | **[C](./docs/tools/brightdata-mcp.md)** | 🔑 `AS-002` ×67, ⚡ `AS-011` ×58, `AS-014` ×65 | May 18 |
| [obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server) | `3.2.0` | 31.3k/mo | **[B](./docs/tools/obsidian-mcp-server.md)** | 🔑 `AS-002` ×9, `AS-014` ×13, ⚡ `AS-011` ×2 | May 18 |
| [github-mcp-server](https://github.com/github/github-mcp-server) | `1.0.4` | 29.9k | **[C](./docs/tools/github-mcp-server.md)** | 🔑 `AS-002` ×75, ⚡ `AS-011` ×36, `AS-014` ×86, 📐 `AS-003`, 🗝️ `AS-010` | May 18 |
| [railway-mcp-server](https://github.com/railwayapp/railway-mcp-server) | `0.1.11` | 28.5k/mo | **[C](./docs/tools/railway-mcp-server.md)** | 🔑 `AS-002` ×20, ⚡ `AS-011` | May 18 |
...
| [postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server) | `2.8.9` | 19.7k/mo | **[C](./docs/tools/postman-mcp-server.md)** | 🔑 `AS-002` ×53, ⚡ `AS-011` ×15, `AS-014` ×41 | May 18 |
| [mcp-server](https://github.com/mapbox/mcp-server) | `99.0.0-dev` | 19.7k/mo | **[C](./docs/tools/mcp-server.md)** | 🔑 `AS-002` ×15, ⚡ `AS-011` ×6 | May 18 |
| [mcp-server-asana](https://github.com/roychri/mcp-server-asana) | `1.6.0` | 16.0k/mo | **[C](./docs/tools/mcp-server-asana.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×3, `AS-014` ×10 | May 18 |
...
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 14.9k/mo | **[D](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | May 18 |
| [openmetadata](https://github.com/open-metadata/OpenMetadata) | `1.2.1` | 13.9k | **[C](./docs/tools/openmetadata.md)** | `AS-014` ×31, 🔑 `AS-002` ×11, ⚡ `AS-011` ×8 | May 18 |
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | `2026.05.15…` | 13.6k | **[C](./docs/tools/xiaohongshu-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×10 | May 18 |
| [skill-seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | `3.6.0` | 13.6k | **[B](./docs/tools/skill-seekers.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×5 | May 18 |
| [pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server) | `9.8.2` | 11.5k | **[B](./docs/tools/pal-mcp-server.md)** | 🔑 `AS-002` ×5, `AS-014` ×4, ⚡ `AS-011` ×3 | May 18 |
