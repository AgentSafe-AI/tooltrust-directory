...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1794-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--08--07-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1794 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 194.9M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Aug 7 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.79` | 27.4M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Aug 7 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 10.8M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Aug 7 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 7.9M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Aug 7 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 3.9M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Aug 7 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.1M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Aug 7 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.55.0-pre…` | 1.9M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Aug 7 |
...
| [inspector](https://github.com/modelcontextprotocol/inspector) | `2-alpha-15` | 926.7k/mo | **[A](./docs/tools/inspector.md)** | `AS-014` ×2 | Aug 7 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 749.6k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Aug 7 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 625.4k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Aug 7 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.68.0` | 592.8k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Aug 7 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 563.5k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Aug 7 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 394.3k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Aug 7 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.47` | 361.4k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Aug 7 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 335.7k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 7 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `0.21.7` | 306.3k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×23, 🔑 `AS-002`, ⚡ `AS-011` | Aug 7 |
...
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 230.0k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Aug 7 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.136.0` | 144.7k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Aug 7 |
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.20.0` | 143.3k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×13, `AS-014` ×13, 📐 `AS-003` ×2 | Aug 7 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 142.3k/mo | **[C](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Aug 7 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.22` | 132.6k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Aug 7 |
| [n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp) | `0.1.37` | 127.2k/mo | **[A](./docs/tools/n8n-nodes-mcp.md)** | `AS-014` ×27, 🔑 `AS-002` ×21, ⚡ `AS-011` ×9, 🗝️ `AS-010` | Aug 7 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 108.9k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 7 |
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.39.1` | 108.1k/mo | **[C](./docs/tools/figma-console-mcp.md)** | `AS-012`, `AS-014` ×114, 🔑 `AS-002` ×71, ⚡ `AS-011` ×41, ⚡ `AS-006`, 🗝️ `AS-010` | Aug 7 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 89.3k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Aug 7 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.0` | 85.6k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 7 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 85.5k/mo | **[C](./docs/tools/mcp-playwright.md)** | `AS-012`, `AS-014` ×33, 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×9, 🗝️ `AS-010` ×5 | Aug 7 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.1` | 84.1k/mo | **[A](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×5, `AS-014` ×27 | Aug 7 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.2` | 80.0k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Aug 7 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.5.23` | 79.4k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×39, `AS-014` ×39, ⚡ `AS-011` ×5 | Aug 7 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.34.0` | 78.2k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Aug 7 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.14.2` | 78.1k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Aug 7 |
...
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 67.7k | **[A](./docs/tools/agent-reach.md)** | `AS-014` ×13, 🔑 `AS-002` ×4, 🗝️ `AS-010` ×12, ⚡ `AS-011` ×2 | Aug 7 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.14.0` | 65.3k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Aug 7 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.34.0` | 65.2k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 7 |
| [neo](https://github.com/neomjs/neo) | `11.19.1` | 64.5k/mo | **[A](./docs/tools/neo.md)** | `AS-014` ×8 | Aug 7 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.6.0` | 58.2k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 7 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 54.6k/mo | **[A](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Aug 7 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 49.5k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Aug 7 |
...
| [browsermcp](https://github.com/browsermcp/mcp) | `0.1.3` | 44.8k/mo | **[A](./docs/tools/browsermcp.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×12 | Aug 7 |
...
| [kong](https://github.com/Kong/kong) | `3.9.3` | 43.9k | **[A](./docs/tools/kong.md)** | `AS-014` | Aug 7 |
