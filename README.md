...
*Top 50 by stars. View all 161 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Stars | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [n8n](https://github.com/n8n-io/n8n) | `n8n@2.14.2` | 181.9k | **[C](./docs/tools/n8n.md)** | 🔑 `AS-002` ×27, ⚡ `AS-011` ×9, ⚡ `AS-006`, 🗝️ `AS-010` | Mar 31 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.35.3` | 99.7k | **[D](./docs/tools/gemini-cli.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×5, 🗝️ `AS-010` ×2 | Mar 31 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `2026.1.26` | 82.6k | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | ✅ None | Mar 31 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `2026.1.26` | 82.6k | **[A](./docs/tools/mcp-server-time.md)** | ✅ None | Mar 31 |
| [mcp-server-fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) | `2026.1.26` | 82.6k | **[B](./docs/tools/mcp-server-fetch.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3 | Mar 31 |
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `2026.1.26` | 82.6k | **[C](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×15, ⚡ `AS-011` | Mar 31 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `2026.1.26` | 82.6k | **[C](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×35, ⚡ `AS-011` ×18 | Mar 31 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `2026.1.26` | 82.6k | **[C](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×14, ⚡ `AS-011` ×6 | Mar 31 |
| [context7](https://github.com/upstash/context7) | `ctx7@0.3.9` | 51.2k | **[B](./docs/tools/context7.md)** | 🔑 `AS-002`, ⚡ `AS-011` | Mar 31 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 32.6k | **[C](./docs/tools/chrome-devtools-mcp.md)** | 🔑 `AS-002` ×14, ⚡ `AS-006`, ⚡ `AS-011` ×3 | Mar 31 |
| [ui-tars-desktop](https://github.com/bytedance/UI-TARS-desktop) | `0.3.0` | 29.2k | **[D](./docs/tools/ui-tars-desktop.md)** | 🔑 `AS-002` ×26, 📐 `AS-003` ×7, ⚡ `AS-011` ×6 | Mar 31 |
...
| [openmetadata](https://github.com/open-metadata/OpenMetadata) | `1.12.4-rel…` | 9.1k | **[B](./docs/tools/openmetadata.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` | Mar 31 |
| [browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp) | `1.2.0` | 7.2k | **[B](./docs/tools/browser-tools-mcp.md)** | `AS-012`, 🔑 `AS-002`, ⚡ `AS-011` | Mar 31 |
...
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.38` | 5.8k | **[C](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×22, ⚡ `AS-011` ×8, 📐 `AS-003` | Mar 31 |
| [klavis](https://github.com/Klavis-AI/klavis) | `python-v2.…` | 5.7k | **[B](./docs/tools/klavis.md)** | 🔑 `AS-002`, ⚡ `AS-011` | Mar 31 |
| [whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) | `0.0.1` | 5.5k | **[C](./docs/tools/whatsapp-mcp.md)** | 🔑 `AS-002` ×14, ⚡ `AS-011` ×7 | Mar 31 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.3.2` | 5.0k | **[B](./docs/tools/xcodebuildmcp.md)** | 🔑 `AS-002` ×35, ⚡ `AS-011` ×3 | Mar 31 |
| [deep-research](https://github.com/u14app/deep-research) | `0.11.0` | 4.6k | **[C](./docs/tools/deep-research.md)** | `AS-012`, 🔑 `AS-002` ×8, ⚡ `AS-011` ×7 | Mar 31 |
| [osaurus](https://github.com/osaurus-ai/osaurus) | `0.15.15` | 4.5k | **[A](./docs/tools/osaurus.md)** | ✅ None | Mar 31 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.50` | 4.3k | **[B](./docs/tools/mobile-mcp.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` | Mar 31 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.1.0` | 4.1k | **[C](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×22 | Mar 31 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.0` | 4.1k | **[D](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×3, ⚡ `AS-006` | Mar 31 |
| [kubefwd](https://github.com/txn2/kubefwd) | `1.25.13` | 4.1k | **[B](./docs/tools/kubefwd.md)** | 🔑 `AS-002` ×4, ⚡ `AS-011` | Mar 31 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 3.9k | **[B](./docs/tools/mcp-server-chart.md)** | 🔑 `AS-002`, ⚡ `AS-011` | Mar 31 |
| [fast-agent](https://github.com/evalstate/fast-agent) | `0.6.7` | 3.7k | **[A](./docs/tools/fast-agent.md)** | ✅ None | Mar 31 |
| [excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) | `0.1.7` | 3.6k | **[B](./docs/tools/excel-mcp-server.md)** | 🔑 `AS-002` ×17, ⚡ `AS-011` ×3, 🗝️ `AS-010` | Mar 31 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `@repo/mcp-…` | 3.6k | **[D](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×2, ⚡ `AS-006` | Mar 31 |
| [archestra](https://github.com/archestra-ai/archestra) | `platform-v…` | 3.5k | **[A](./docs/tools/archestra.md)** | ✅ None | Mar 31 |
| [mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) | `3.0.0` | 3.2k | **[B](./docs/tools/mcp-server-browserbase.md)** | 🔑 `AS-002`, ⚡ `AS-011` | Mar 31 |
| [shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) | `2.0.0` | 2.7k | **[A](./docs/tools/shadcn-ui-mcp-server.md)** | 🔑 `AS-002` | Mar 31 |
| [solon](https://github.com/opensolon/solon) | `3.9.5` | 2.7k | **[A](./docs/tools/solon.md)** | ✅ None | Mar 10 |
| [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | `2.9.3` | 2.3k | **[C](./docs/tools/brightdata-mcp.md)** | 🔑 `AS-002` ×66, ⚡ `AS-011` ×57 | Mar 31 |
...
| [mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager) | `1.0.21` | 2.1k | **[C](./docs/tools/mcp-shrimp-task-manager.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×6 | Mar 31 |
| [google-workspace-mcp](https://github.com/taylorwilsdon/google_workspace_mcp) | `1.16.2` | 2.0k | **[B](./docs/tools/google-workspace-mcp.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2 | Mar 31 |
| [mcp-router](https://github.com/mcp-router/mcp-router) | `0.6.2` | 1.9k | **[A](./docs/tools/mcp-router.md)** | ✅ None | Mar 31 |
| [unity-mcp](https://github.com/IvanMurzak/Unity-MCP) | `0.63.2` | 1.8k | **[B](./docs/tools/unity-mcp.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` | Mar 31 |
...
| 🚨&nbsp;**AS&#8209;016** | `Critical` | **Suspicious NPM IOC Dependency** — published npm metadata references a known malicious IOC package such as `plain-crypto-js`, even if the top-level package name is new |
