...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1228-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--06--14-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1228 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.76` | 19.3M/mo | **[D](./docs/tools/playwright-mcp.md)** | 📦 `AS-004` ×23, 🔑 `AS-002` ×15, ⚡ `AS-006` ×2, ⚡ `AS-011` ×6 | Jun 14 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 10.0M/mo | **[D](./docs/tools/chrome-devtools-mcp.md)** | 📦 `AS-004` ×29, 🔑 `AS-002` ×16, ⚡ `AS-011` ×4, ⚡ `AS-006` | Jun 14 |
| [upstash-context7-mcp](https://github.com/upstash/context7) | `1.0.30` | 4.5M/mo | **[B](./docs/tools/upstash-context7-mcp.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Jun 14 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.5M/mo | **[B](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Jun 14 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.48.0-nig…` | 2.9M/mo | **[C](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×35, ⚡ `AS-011` ×11 | Jun 14 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 1.1M/mo | **[C](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×15, 📦 `AS-004` ×14, ⚡ `AS-011` | Jun 14 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 593.5k/mo | **[C](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×35, 📦 `AS-004` ×26, ⚡ `AS-011` ×18 | Jun 14 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.57.4` | 520.9k/mo | **[C](./docs/tools/n8n-mcp.md)** | 📦 `AS-004` ×7, 🔑 `AS-002` ×7, ⚡ `AS-011` ×2 | Jun 14 |
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.6.2` | 453.9k/mo | **[B](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×35, ⚡ `AS-011` ×3 | Jun 14 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 425.1k/mo | **[B](./docs/tools/mcp-server-sequential-thinking.md)** | 📦 `AS-004` | Jun 14 |
...
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.1.0` | 360.9k/mo | **[D](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×30, 📦 `AS-004` ×22, ⚡ `AS-011` ×22 | Jun 14 |
...
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.20` | 188.7k/mo | **[C](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×10, 📦 `AS-004` ×5, ⚡ `AS-011` ×5 | Jun 14 |
...
| [ruflo](https://github.com/ruvnet/ruflo) | `3.10.46` | 148.7k/mo | **[B](./docs/tools/ruflo.md)** | `AS-014` ×33, 🔑 `AS-002` ×25, ⚡ `AS-011` | Jun 14 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `3.9.1` | 127.2k/mo | **[B](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Jun 14 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.162` | 114.0k/mo | **[C](./docs/tools/context-mode.md)** | `AS-012`, 🔑 `AS-002` ×9, `AS-014` ×7, ⚡ `AS-011` | Jun 14 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.42` | 104.6k/mo | **[C](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×22, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Jun 14 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.119.0` | 101.6k/mo | **[D](./docs/tools/ms-365-mcp-server.md)** | 📦 `AS-004` ×178, 🔑 `AS-002` ×377, ⚡ `AS-011` ×172 | Jun 14 |
...
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 92.4k/mo | **[C](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Jun 14 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 87.2k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Jun 14 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.1` | 84.6k/mo | **[C](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×4, 📦 `AS-004` ×2, ⚡ `AS-011` ×2 | Jun 14 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.59` | 77.7k/mo | **[C](./docs/tools/mobile-mcp.md)** | 📦 `AS-004` ×23, 🔑 `AS-002` ×5, ⚡ `AS-011` | Jun 14 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.11.0` | 75.7k/mo | **[D](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×27, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Jun 14 |
| [claude-task-master](https://github.com/eyaltoledano/claude-task-master) | `0.20.0` | 65.2k/mo | **[B](./docs/tools/claude-task-master.md)** | `AS-014` ×14, 🔑 `AS-002` ×9, ⚡ `AS-011` | Jun 14 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.0.83` | 63.9k/mo | **[C](./docs/tools/brave-search-mcp-server.md)** | 🔑 `AS-002` ×12, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Jun 14 |
...
| [obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server) | `3.2.7` | 32.8k/mo | **[B](./docs/tools/obsidian-mcp-server.md)** | 🔑 `AS-002` ×9, `AS-014` ×13, ⚡ `AS-011` ×2 | Jun 14 |
...
| [brightdata-mcp](https://github.com/brightdata/brightdata-mcp) | `2.10.0` | 31.1k/mo | **[C](./docs/tools/brightdata-mcp.md)** | 🔑 `AS-002` ×67, ⚡ `AS-011` ×58, `AS-014` ×65 | Jun 14 |
| [github-mcp-server](https://github.com/github/github-mcp-server) | `1.3.0` | 30.6k | **[C](./docs/tools/github-mcp-server.md)** | 🔑 `AS-002` ×75, ⚡ `AS-011` ×36, `AS-014` ×86, 📐 `AS-003`, 🗝️ `AS-010` | Jun 14 |
...
| [postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server) | `2.9.1` | 25.9k/mo | **[C](./docs/tools/postman-mcp-server.md)** | 🔑 `AS-002` ×53, ⚡ `AS-011` ×15, `AS-014` ×41 | Jun 14 |
| [mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) | `3.0.0` | 22.1k/mo | **[C](./docs/tools/mcp-server-browserbase.md)** | 📦 `AS-004` ×6, 🔑 `AS-002`, ⚡ `AS-011` | Jun 14 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 20.9k/mo | **[B](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Jun 14 |
| [mcp-server-asana](https://github.com/roychri/mcp-server-asana) | `1.6.0` | 20.6k/mo | **[C](./docs/tools/mcp-server-asana.md)** | 🔑 `AS-002` ×8, ⚡ `AS-011` ×3, `AS-014` ×10 | Jun 14 |
| [aas-ee-open-websearch](https://github.com/Aas-ee/open-webSearch) | `2.1.11` | 20.3k/mo | **[C](./docs/tools/aas-ee-open-websearch.md)** | 🔑 `AS-002` ×7, 📦 `AS-004` ×6, ⚡ `AS-011` ×6 | Jun 14 |
...
| [git-mcp-server](https://github.com/cyanheads/git-mcp-server) | `2.15.1` | 15.2k/mo | **[C](./docs/tools/git-mcp-server.md)** | 🔑 `AS-002` ×39, 📦 `AS-004` ×28, ⚡ `AS-011` ×9 | Jun 14 |
| [openmetadata](https://github.com/open-metadata/OpenMetadata) | `1.2.1` | 14.2k | **[C](./docs/tools/openmetadata.md)** | `AS-012`, 🔑 `AS-002` ×13, ⚡ `AS-011` ×6, `AS-014` ×9 | Jun 14 |
...
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | `2026.06.12…` | 14.1k | **[C](./docs/tools/xiaohongshu-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×10 | Jun 14 |
| [skill-seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | `3.7.0` | 14.1k | **[B](./docs/tools/skill-seekers.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×5 | Jun 14 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 13.7k/mo | **[D](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×5, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Jun 14 |
