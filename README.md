...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1802-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--08--01-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1802 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.78` | 26.9M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Aug 1 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 9.7M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Aug 1 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 9.2M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Aug 1 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.1M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Aug 1 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.2M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Aug 1 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.55.0-nig…` | 2.0M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Aug 1 |
...
| [inspector](https://github.com/modelcontextprotocol/inspector) | `2-alpha-15` | 868.7k/mo | **[A](./docs/tools/inspector.md)** | `AS-014` ×2 | Aug 1 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 711.8k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Aug 1 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 698.7k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Aug 1 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.67.2` | 587.6k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Aug 1 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 559.5k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Aug 1 |
| [azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp) | `2.9.0` | 528.4k/mo | **[A](./docs/tools/azure-devops-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 1 |
...
| [xcodebuildmcp](https://github.com/getsentry/XcodeBuildMCP) | `2.7.0` | 436.3k/mo | **[A](./docs/tools/xcodebuildmcp.md)** | `AS-014` ×71, 🔑 `AS-002` ×31, ⚡ `AS-011` ×3 | Aug 1 |
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 340.9k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×32, ⚡ `AS-011` ×25, `AS-014` ×26 | Aug 1 |
| [figma-context-mcp](https://github.com/GLips/Figma-Context-MCP) | `0.13.2` | 319.2k/mo | **[A](./docs/tools/figma-context-mcp.md)** | `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 1 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.46` | 306.1k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Aug 1 |
| [mcp-framework](https://github.com/QuantGeekDev/mcp-framework) | `mcp-framew…` | 241.7k/mo | **[A](./docs/tools/mcp-framework.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 1 |
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 215.9k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Aug 1 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.19.1` | 138.7k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×11, `AS-014` ×13, 📐 `AS-003` ×2 | Aug 1 |
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.136.0` | 137.8k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Aug 1 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.21` | 132.1k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Aug 1 |
...
| [figma-console-mcp](https://github.com/southleft/figma-console-mcp) | `1.38.2` | 122.9k/mo | **[B](./docs/tools/figma-console-mcp.md)** | `AS-012`, `AS-014` ×9, 🔑 `AS-002`, ⚡ `AS-011` | Aug 1 |
| [mcp-server-trello](https://github.com/delorenj/mcp-server-trello) | `1.8.1` | 122.0k/mo | **[A](./docs/tools/mcp-server-trello.md)** | 🔑 `AS-002` ×106, `AS-014` ×200, ⚡ `AS-011` ×53, 🗝️ `AS-010` | Aug 1 |
| [mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) | `workers-ob…` | 115.8k/mo | **[C](./docs/tools/mcp-server-cloudflare.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2, ⚡ `AS-006` | Aug 1 |
| [mcp-server-brave-search](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search) | `typescript…` | 106.9k/mo | **[A](./docs/tools/mcp-server-brave-search.md)** | 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 1 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 103.3k/mo | **[A](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Aug 1 |
| [brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) | `2.1.0` | 94.9k/mo | **[B](./docs/tools/brave-search-mcp-server.md)** | `AS-012`, 🔑 `AS-002` ×10, ⚡ `AS-011` ×7, `AS-014` ×8, 🗝️ `AS-010` ×2 | Aug 1 |
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 89.1k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Aug 1 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.34.0` | 88.2k/mo | **[A](./docs/tools/ruflo.md)** | 🔑 `AS-002` ×21, ⚡ `AS-011` ×18, `AS-014` ×27 | Aug 1 |
| [mcp-playwright](https://github.com/executeautomation/mcp-playwright) | `1.0.12` | 82.5k/mo | **[C](./docs/tools/mcp-playwright.md)** | 🔑 `AS-002` ×6, `AS-014` ×6, ⚡ `AS-011` ×5, ⚡ `AS-006` | Aug 1 |
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `0.0.62` | 82.3k/mo | **[A](./docs/tools/mobile-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×5, ⚡ `AS-011` | Aug 1 |
| [context-mode](https://github.com/mksglu/context-mode) | `1.0.169` | 82.1k/mo | **[A](./docs/tools/context-mode.md)** | 🔑 `AS-002` ×7, `AS-014` ×7, ⚡ `AS-011` | Aug 1 |
| [worldmonitor](https://github.com/koala73/worldmonitor) | `2.5.23` | 77.5k | **[A](./docs/tools/worldmonitor.md)** | 🔑 `AS-002` ×39, `AS-014` ×39, ⚡ `AS-011` ×5 | Aug 1 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.2` | 77.2k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Aug 1 |
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.14.1` | 73.1k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Aug 1 |
...
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.2.1` | 69.0k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 1 |
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.33.0` | 63.6k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 1 |
| [agent-reach](https://github.com/Panniantong/Agent-Reach) | `1.5.0` | 63.4k | **[A](./docs/tools/agent-reach.md)** | `AS-014` ×4, 🔑 `AS-002` ×3, ⚡ `AS-011` ×2 | Aug 1 |
| [mempalace](https://github.com/MemPalace/mempalace) | `3.6.0` | 57.9k | **[A](./docs/tools/mempalace.md)** | `AS-014` ×3, 🔑 `AS-002` ×2, ⚡ `AS-011` | Aug 1 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.13.0` | 56.8k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Aug 1 |
| [neo](https://github.com/neomjs/neo) | `11.19.1` | 56.2k/mo | **[A](./docs/tools/neo.md)** | `AS-014` ×8 | Aug 1 |
