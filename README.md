...
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [n8n](https://github.com/n8n-io/n8n) | `n8n@2.11.4` | 179.5k | **[B](./docs/tools/n8n.md)** | ⚠️ `AS-002` ×5, `AS-011` ×4, `AS-007` ×60 | Mar 17 |
...
| [trendradar](https://github.com/sansan0/TrendRadar) | `6.5.0` | 49.1k | **[B](./docs/tools/trendradar.md)** | ⚠️ `AS-002` ×3, `AS-011` ×2, `AS-007` ×9 | Mar 17 |
| [scrapling](https://github.com/D4Vinci/Scrapling) | `0.4.2` | 30.4k | **[B](./docs/tools/scrapling.md)** | `AS-007` ×20, ⚠️ `AS-002`, `AS-011` | Mar 17 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 29.5k | **[A](./docs/tools/chrome-devtools-mcp.md)** | `AS-007` ×60 | Mar 17 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.68` | 29.1k | **[A](./docs/tools/playwright-mcp.md)** | `AS-007` ×8 | Mar 17 |
| [ui-tars-desktop](https://github.com/bytedance/UI-TARS-desktop) | `0.3.0` | 28.9k | **[C](./docs/tools/ui-tars-desktop.md)** | `AS-006` ×2, `AS-007` ×60, ⚠️ `AS-002` ×6, `AS-011` ×6, `AS-003` | Mar 17 |
| [github-mcp-server](https://github.com/github/github-mcp-server) | `0.32.0` | 28.0k | **[C](./docs/tools/github-mcp-server.md)** | `AS-007` ×60, ⚠️ `AS-002` ×12, `AS-011` ×2 | Mar 17 |
...
| [gpt-researcher](https://github.com/assafelovic/gpt-researcher) | `3.4.3` | 25.8k | **[B](./docs/tools/gpt-researcher.md)** | ⚠️ `AS-002` ×5, `AS-007` ×32, `AS-011` ×3 | Mar 17 |
| [serena](https://github.com/oraios/serena) | `0.1.4` | 21.6k | **[A](./docs/tools/serena.md)** | `AS-007` ×18 | Mar 17 |
| [ruflo](https://github.com/ruvnet/ruflo) | `3.5.15` | 21.4k | **[B](./docs/tools/ruflo.md)** | ⚠️ `AS-002` ×12, `AS-011` ×8, `AS-007` ×60 | Mar 17 |
| [activepieces](https://github.com/activepieces/activepieces) | `0.79.3` | 21.2k | **[B](./docs/tools/activepieces.md)** | ⚠️ `AS-002` ×8, `AS-011` ×2, `AS-007` ×60 | Mar 17 |
| [maxkb](https://github.com/1Panel-dev/MaxKB) | `2.6.1` | 20.4k | **[B](./docs/tools/maxkb.md)** | `AS-007` ×60, ⚠️ `AS-002`, `AS-011` | Mar 17 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.37.3` | 15.3k | **[B](./docs/tools/n8n-mcp.md)** | ⚠️ `AS-002` ×13, `AS-011` ×5, `AS-007` ×60 | Mar 17 |
| [trigger-dev](https://github.com/triggerdotdev/trigger.dev) | `4.4.3` | 14.1k | **[B](./docs/tools/trigger-dev.md)** | ⚠️ `AS-002` ×10, `AS-011` ×3, `AS-007` ×60 | Mar 17 |
...
| [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) | `2026.03.09…` | 11.7k | **[C](./docs/tools/xiaohongshu-mcp.md)** | `AS-007` ×15, ⚠️ `AS-002` ×2, `AS-003`, `AS-011` | Mar 17 |
| [fastapi-mcp](https://github.com/tadata-org/fastapi_mcp) | `0.4.0` | 11.7k | **[A](./docs/tools/fastapi-mcp.md)** | `AS-007` ×8, ⚠️ `AS-002` | Mar 17 |
| [pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server) | `9.8.2` | 11.3k | **[B](./docs/tools/pal-mcp-server.md)** | `AS-007` ×54, ⚠️ `AS-002` ×4, `AS-011` ×4 | Mar 17 |
| [skill-seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | `3.3.0` | 10.9k | **[C](./docs/tools/skill-seekers.md)** | `AS-007` ×60, ⚠️ `AS-002` ×2, `AS-011` ×2, `AS-003` | Mar 17 |
| [nginx-ui](https://github.com/0xJacky/nginx-ui) | `2.3.5` | 10.9k | **[A](./docs/tools/nginx-ui.md)** | `AS-007` ×60 | Mar 17 |
| [xhs-downloader](https://github.com/JoeanAmier/XHS-Downloader) | `2.7` | 10.4k | **[B](./docs/tools/xhs-downloader.md)** | ⚠️ `AS-002` ×2, `AS-007` ×9, `AS-011` ×2 | Mar 17 |
| [mcp-use](https://github.com/mcp-use/mcp-use) | `python-v1.…` | 9.4k | **[B](./docs/tools/mcp-use.md)** | ⚠️ `AS-002` ×4, `AS-011` ×4, `AS-007` ×60 | Mar 17 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 5.8k | **[B](./docs/tools/firecrawl-mcp-server.md)** | ⚠️ `AS-002` ×6, `AS-007` ×6, `AS-011` ×6 | Mar 17 |
| [klavis](https://github.com/Klavis-AI/klavis) | `python-v2.…` | 5.7k | **[B](./docs/tools/klavis.md)** | ⚠️ `AS-002`, `AS-011` | Mar 17 |
| [viper](https://github.com/FunnyWolf/Viper) | `3.1.10` | 5.0k | **[A](./docs/tools/viper.md)** | `AS-007` ×6 | Mar 17 |
...
| [deep-research](https://github.com/u14app/deep-research) | `0.11.0` | 4.5k | **[B](./docs/tools/deep-research.md)** | `AS-007` ×38, ⚠️ `AS-002` ×4, `AS-011` ×4 | Mar 17 |
| [osaurus](https://github.com/osaurus-ai/osaurus) | `0.14.16` | 4.3k | **[A](./docs/tools/osaurus.md)** | `AS-007` | Mar 17 |
| [httprunner](https://github.com/httprunner/httprunner) | `4.3.6` | 4.3k | **[B](./docs/tools/httprunner.md)** | `AS-007` ×52, ⚠️ `AS-002` ×2, `AS-011` ×2 | Mar 17 |
| [enscan-go](https://github.com/wgpsec/ENScan_GO) | `2.0.4` | 4.3k | **[A](./docs/tools/enscan-go.md)** | `AS-007` ×2 | Mar 17 |
