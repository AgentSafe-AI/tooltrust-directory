...
[![Tools Audited](https://img.shields.io/badge/tools%20audited-1760-brightgreen)](./data/reports/)
[![Last Scan](https://img.shields.io/badge/last%20scan-2026--08--05-blue)](./data/reports/)
...
*Top 50 by popularity. View all 1760 tools → [Full Directory](./docs/full-directory.md) · [data/reports/](./data/reports/) · [docs/tools/](./docs/tools/)*

| Tool | Version | Popularity | Grade | Key Findings | Scanned |
|------|---------|:-----:|:-----:|:-------------|:-------:|
| [typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk) | `2.0.0-beta.1` | 186.6M/mo | **[A](./docs/tools/typescript-sdk.md)** | `AS-014` | Aug 5 |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | `0.0.78` | 26.4M/mo | **[C](./docs/tools/playwright-mcp.md)** | `AS-014` ×24, 🔑 `AS-002` ×11, ⚡ `AS-006` ×2, ⚡ `AS-011` ×5 | Aug 5 |
| [ext-apps](https://github.com/modelcontextprotocol/ext-apps) | `1.7.5` | 10.1M/mo | **[A](./docs/tools/ext-apps.md)** | 🔑 `AS-002`, `AS-014` ×3 | Aug 5 |
| [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | `chrome-dev…` | 8.2M/mo | **[C](./docs/tools/chrome-devtools-mcp.md)** | `AS-014` ×29, 🔑 `AS-002` ×13, ⚡ `AS-011` ×4, ⚡ `AS-006` | Aug 5 |
| [context7](https://github.com/upstash/context7) | `1.0.30` | 4.0M/mo | **[A](./docs/tools/context7.md)** | `AS-014` ×2, 🔑 `AS-002`, ⚡ `AS-011` | Aug 5 |
...
| [mcp-server-filesystem](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) | `typescript…` | 2.2M/mo | **[A](./docs/tools/mcp-server-filesystem.md)** | 🔑 `AS-002` ×14, `AS-014` ×14, ⚡ `AS-011` | Aug 5 |
| [gemini-cli](https://github.com/google-gemini/gemini-cli) | `0.55.0-nig…` | 1.9M/mo | **[A](./docs/tools/gemini-cli.md)** | `AS-014` ×56, 🔑 `AS-002` ×23, ⚡ `AS-011` ×11 | Aug 5 |
...
| [inspector](https://github.com/modelcontextprotocol/inspector) | `2-alpha-15` | 880.9k/mo | **[A](./docs/tools/inspector.md)** | `AS-014` ×2 | Aug 5 |
| [notion-mcp-server](https://github.com/makenotion/notion-mcp-server) | `2.5.0` | 724.2k/mo | **[A](./docs/tools/notion-mcp-server.md)** | 🔑 `AS-002` ×24, ⚡ `AS-011` ×24, `AS-014` ×24 | Aug 5 |
| [mcp-server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking) | `typescript…` | 719.8k/mo | **[A](./docs/tools/mcp-server-sequential-thinking.md)** | `AS-014` | Aug 5 |
| [n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | `2.68.0` | 579.8k/mo | **[A](./docs/tools/n8n-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×8, ⚡ `AS-011` ×4 | Aug 5 |
| [mcp-server-github](https://github.com/modelcontextprotocol/servers/tree/main/src/github) | `typescript…` | 551.4k/mo | **[A](./docs/tools/mcp-server-github.md)** | 🔑 `AS-002` ×24, `AS-014` ×26, ⚡ `AS-011` ×18 | Aug 5 |
...
| [firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server) | `3.2.1` | 339.2k/mo | **[A](./docs/tools/firecrawl-mcp-server.md)** | 🔑 `AS-002` ×30, ⚡ `AS-011` ×24, `AS-014` ×25 | Aug 5 |
| [desktopcommandermcp](https://github.com/wonderwhy-er/DesktopCommanderMCP) | `0.2.47` | 300.3k/mo | **[B](./docs/tools/desktopcommandermcp.md)** | 🔑 `AS-002` ×19, `AS-014` ×26, ⚡ `AS-011` ×8, 📐 `AS-003` | Aug 5 |
| [qwen-code](https://github.com/QwenLM/qwen-code) | `0.21.6-pre…` | 300.0k/mo | **[A](./docs/tools/qwen-code.md)** | `AS-014` ×54 | Aug 5 |
...
| [mcpb](https://github.com/modelcontextprotocol/mcpb) | `2.1.2` | 220.2k/mo | **[C](./docs/tools/mcpb.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×10, ⚡ `AS-006` | Aug 5 |
...
| [ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server) | `0.136.0` | 142.3k/mo | **[A](./docs/tools/ms-365-mcp-server.md)** | `AS-014` ×188, 🔑 `AS-002` ×229, ⚡ `AS-011` ×182 | Aug 5 |
...
| [mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci) | `0.19.1` | 134.5k/mo | **[B](./docs/tools/mcp-server-circleci.md)** | 🔑 `AS-002` ×13, ⚡ `AS-011` ×11, `AS-014` ×13, 📐 `AS-003` ×2 | Aug 5 |
| [tavily-mcp](https://github.com/tavily-ai/tavily-mcp) | `0.2.21` | 127.7k/mo | **[A](./docs/tools/tavily-mcp.md)** | 🔑 `AS-002` ×7, ⚡ `AS-011` ×5, `AS-014` ×5 | Aug 5 |
...
| [mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/main/src/time) | `typescript…` | 89.2k | **[A](./docs/tools/mcp-server-time.md)** | `AS-014` ×2 | Aug 5 |
...
| [mobile-mcp](https://github.com/mobile-next/mobile-mcp) | `1.0.0` | 80.8k/mo | **[A](./docs/tools/mobile-mcp.md)** | `AS-014` ×23, 🔑 `AS-002` ×5, ⚡ `AS-011` | Aug 5 |
| [mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) | `4.1.2` | 79.8k/mo | **[A](./docs/tools/mcp-server-kubernetes.md)** | `AS-014` ×22, 🔑 `AS-002` ×6, ⚡ `AS-011` ×3 | Aug 5 |
| [exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) | `3.4.0` | 79.5k/mo | **[A](./docs/tools/exa-mcp-server.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 5 |
...
| [apify-mcp-server](https://github.com/apify/apify-mcp-server) | `0.14.1` | 74.1k/mo | **[C](./docs/tools/apify-mcp-server.md)** | 🔑 `AS-002` ×16, ⚡ `AS-011` ×7, `AS-014` ×16, ⚡ `AS-006` ×2 | Aug 5 |
| [mcp-server-chart](https://github.com/antvis/mcp-server-chart) | `0.9.10` | 73.3k/mo | **[A](./docs/tools/mcp-server-chart.md)** | `AS-014` ×26, 🔑 `AS-002`, ⚡ `AS-011` | Aug 5 |
...
| [headroom](https://github.com/headroomlabs-ai/headroom) | `0.33.0` | 64.8k | **[A](./docs/tools/headroom.md)** | 🔑 `AS-002` ×2, ⚡ `AS-011` ×2, `AS-014` ×2 | Aug 5 |
| [mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng) | `1.14.0` | 64.7k/mo | **[A](./docs/tools/mcp-searxng.md)** | 🔑 `AS-002` ×3, ⚡ `AS-011` ×3, `AS-014` ×4 | Aug 5 |
...
| [anytype-mcp](https://github.com/anyproto/anytype-mcp) | `1.2.10` | 48.8k/mo | **[B](./docs/tools/anytype-mcp.md)** | `AS-014` ×18, 🔑 `AS-002` ×7, ⚡ `AS-011` ×3, 📐 `AS-003` | Aug 4 |
| [mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) | `2.0.9` | 46.8k/mo | **[A](./docs/tools/mcp-server-mysql.md)** | 🔑 `AS-002` ×4, `AS-014` ×4, ⚡ `AS-011` | Aug 4 |
...
| [browsermcp](https://github.com/browsermcp/mcp) | `0.1.3` | 44.1k/mo | **[A](./docs/tools/browsermcp.md)** | 🔑 `AS-002`, ⚡ `AS-011`, `AS-014` ×12 | Aug 5 |
| [kong](https://github.com/Kong/kong) | `3.9.3` | 43.9k | **[A](./docs/tools/kong.md)** | `AS-014` | Aug 5 |
| [codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | `0.9.1-rc.1` | 37.3k | **[A](./docs/tools/codebase-memory-mcp.md)** | `AS-014` ×9, 🔑 `AS-002` ×6, ⚡ `AS-011` ×2 | Aug 4 |
